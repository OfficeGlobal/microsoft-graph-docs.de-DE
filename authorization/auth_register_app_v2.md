# <a name="register-your-microsoft-graph-application-with-the-azure-ad-v20-endpoint"></a>Registrieren Ihrer Microsoft Graph-Anwendung mit dem Azure AD v2.0-Endpunkt
