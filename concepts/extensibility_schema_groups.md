...
Sehen Sie sich ein [Beispiel für die andere Möglichkeit zum Zuweisen von **id** in der Anforderung](../api-reference/v1.0/api/schemaextension_post_schemaextensions.md#request-2) an, für die nur ein Schemaname angegeben werden muss.
...
- [schemaExtension erstellen](../api-reference/v1.0/api/schemaextension_post_schemaextensions.md)
- [schemaExtension abrufen](../api-reference/v1.0/api/schemaextension_get.md)
- [schemaExtension aktualisieren](../api-reference/v1.0/api/schemaextension_update.md)
- [schemaExtension löschen](../api-reference/v1.0/api/schemaextension_delete.md)
