...
Zum Aufrufen von Microsoft Graph fügen Sie das Zugriffstoken als Bearer-Token an den Autorisierungsheader einer HTML-Anforderung an. Hier sehen Sie z. B. einen Aufruf, der die Profilinformationen des angemeldeten Benutzers zurückgibt (das Zugriffstoken wurde zur besseren Lesbarkeit abgeschnitten):
