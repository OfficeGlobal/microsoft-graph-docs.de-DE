...
---
# <a name="branding-guidelines-for-onenote-api-developers"></a>Branding-Richtlinien für OneNote API-Entwickler 
...
### <a name="icon-and-name-lockup-preferred"></a>Symbol und Name (empfohlen) 
...
### <a name="icon-symbol"></a>Zeichensymbol 
...
Wenn das OneNote-Logo auf weißem oder hellem Hintergrund verwendet wird, ist die bevorzugte Logofarbe lila &mdash; seine Markenfarbe. Wenn es auf einem lila Hintergrund angezeigt wird, sollte das Logo auf Weiß platziert werden.
...
In Umgebungen mit begrenzter Farbpalette und in einfarbigen Designs kann das Logo schwarz sein. Das Logo sollte jedoch niemals grau angezeigt werden.
<!--or white?-->

<a name="do-nots"></a>

## <a name="logo-donts"></a>Unzulässige Verwendung des Logos
...
| Herausgebernamen | Der Name des Herausgebers darf keinen Verweis auf *OneNote* enthalten. Der Namen des Herausgebers darf keine Handelsmarke von Microsoft verletzen. |
...
Wenn Sie zu diesen Richtlinien Fragen haben oder eine neue Kommunikation über die hier gezeigten Brand-Objekte erstellen, wenden Sie sich an uns unter [@onenotedev](https://twitter.com/onenotedev).
