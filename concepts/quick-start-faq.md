...
- [Passport für Node](https://passportjs.org/)
...
Die Schnellstart-Beispiele, die auf der Web-Technologie basieren, stellen die zum Starten und Hosten eines lokalen Webservers erforderliche Logik bereit. Beispielsweise enthält das auf der PHP 5.4.0+ Runtime basierende PHP-Beispiel einen [integrierten Webserver](https://php.net/manual/en/features.commandline.webserver.php), den Sie für die Entwicklung verwenden. Er ist nicht für die Verwendung in einer Produktionsumgebung vorgesehen. 
