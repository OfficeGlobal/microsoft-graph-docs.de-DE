...
- Alle GET-Anforderungen beginnen mit der [Stamm-URL des Diensts](../api-reference/v1.0/resources/onenote-api-overview.md#root-url). <br/><br/>**Beispiele**: `https://www.onenote.com/api/v1.0/me/notes` und `https://www.onenote.com/api/v1.0/myOrganization/siteCollections/{id}/sites/{id}/notes/`
