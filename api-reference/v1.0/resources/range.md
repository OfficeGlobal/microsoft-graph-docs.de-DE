...
|valueTypes|Json|Stellt den Typ der Daten, die jeder Zelle an. Die möglichen Werte sind: `Unknown`, `Empty`, `String`, `Integer`, `Double`, `Boolean`, `Error`. Schreibgeschützt.|
