...
| :--------------------------------------- | :---------- | :--------------------------------------- |
| [Benutzerdetails abrufen](../api/reportroot_getyammerdeviceusageuserdetail.md) | Stream      | Rufen Sie Details zur Yammer-Gerätenutzung nach Benutzer ab. |
| [Benutzeranzahl für Verteilung abrufen](../api/reportroot_getyammerdeviceusagedistributionusercounts.md) | Stream      | Erhalten Sie die Anzahl der Benutzer nach Gerätetyp.  |
| [Benutzeranzahl abrufen](../api/reportroot_getyammerdeviceusageusercounts.md) | Stream      | Erhalten Sie die Anzahl der täglichen Benutzer nach Gerätetyp. |
