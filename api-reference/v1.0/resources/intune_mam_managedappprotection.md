...
|allowedInboundDataTransferSources|Zeichenfolge|Quellen, von denen Daten übermittelt werden dürfen. Mögliche Werte: `allApps`, `managedApps`, `none`.|
|allowedOutboundDataTransferDestinations|Zeichenfolge|Ziele, an die Daten übermittelt werden dürfen. Mögliche Werte: `allApps`, `managedApps`, `none`.|
...
|allowedOutboundClipboardSharingLevel|Zeichenfolge|Regelt die Freigabe der Zwischenablage für Apps auf dem verwalteten Gerät. Mögliche Werte: `allApps`, `managedAppsWithPasteIn`, `managedApps`, `blocked`.|
...
|maximumPinRetries|Int32|Legt die Maximalanzahl von fehlerhaften PIN-Eingaben fest, nach der die verwaltete App zurückgesetzt wird.|
...
|pinCharacterSet|Zeichenfolge|Zulässige Zeichensätze für PINs auf App-Ebene, wenn „pinRequired“ auf „true“ gesetzt ist. Mögliche Werte: `numeric`, `alphanumericAndSymbol`.|
...
|allowedDataStorageLocations|Zeichenfolgenauflistung|Datenspeicherorte, an denen der Benutzer verwaltete Daten speichern darf.|
