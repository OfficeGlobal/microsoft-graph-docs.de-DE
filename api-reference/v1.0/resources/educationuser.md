...
|[Benutzer abrufen](../api/educationuser_get_user.md) |[user](user.md)| Abrufen des einfachen Verzeichnis-**Benutzers**, der diesem **educationUser** entspricht.|
...
|assignments| [educationAssignment](../../beta/resources/educationAssignment.md)| Liste von Zuweisungen für den Benutzer. Lässt Nullwerte zu.|
