...
|:---------------|:--------|:----------|
|[ChartAxis abrufen](../api/chartaxis_get.md) | [WorkbookChartAxis](chartaxis.md) |Dient zum Lesen der Eigenschaften und der Beziehungen des chartAxis-Objekts.|
|[Aktualisieren](../api/chartaxis_update.md) | [WorkbookChartAxis](chartaxis.md)   |Dient zum Aktualisieren des ChartAxis-Objekts. |

## <a name="properties"></a>Eigenschaften
| Eigenschaft     | Typ   |Beschreibung|
|:---------------|:--------|:----------|
| ID       |Zeichenfolge   | Eindeutige Bezeichner. Schreibgeschützt.|
...
|Titel|[WorkbookChartAxisTitle](chartaxistitle.md)|Stellt den Achsentitel dar. Schreibgeschützt.|
