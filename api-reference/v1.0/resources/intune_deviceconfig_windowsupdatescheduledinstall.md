...
|:---|:---|:---|
|scheduledInstallDay|Zeichenfolge|Geplanter Installationstag in der Woche; mögliche Werte sind: `userDefined`, `everyday`, `sunday`, `monday`, `tuesday`, `wednesday`, `thursday`, `friday`, `saturday`.|
