...
|[AndroidWorkProfileCustomConfiguration löschen](../api/intune_deviceconfig_androidworkprofilecustomconfiguration_delete.md)|Keine|Löscht eine [AndroidWorkProfileCustomConfiguration](../resources/intune_deviceconfig_androidworkprofilecustomconfiguration.md).|
|[AndroidWorkProfileCustomConfiguration aktualisieren](../api/intune_deviceconfig_androidworkprofilecustomconfiguration_update.md)|[androidWorkProfileCustomConfiguration](../resources/intune_deviceconfig_androidworkprofilecustomconfiguration.md)|Aktualisieren Sie die Eigenschaften eines [AndroidWorkProfileCustomConfiguration](../resources/intune_deviceconfig_androidworkprofilecustomconfiguration.md) -Objekts.|
...
|omaSettings|Collection von Objekten des Typs [omaSetting](../resources/intune_deviceconfig_omasetting.md)|OMA-Einstellungen. Diese Sammlung darf maximal 500 Elemente enthalten.|
