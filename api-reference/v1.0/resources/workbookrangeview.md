...
|[Bereich](../api/workbookrangeview_range.md)|[workbookRange](range.md)|Rufen Sie das Range-Objekt ab, das mit der Bereichsansicht verknüpft ist.|

## <a name="properties"></a>Eigenschaften
| Eigenschaft     | Typ   |Beschreibung|
|:---------------|:--------|:----------|
|cellAddresses|Json|Stellt die Zellenadressen dar
...
|valueTypes|Json|Stellt den Typ der Daten jeder Zelle dar. Schreibgeschützt. Die möglichen Werte sind: unbekannt, leer, Zeichenfolge, Integer, Double, boolesch, Fehler. |
