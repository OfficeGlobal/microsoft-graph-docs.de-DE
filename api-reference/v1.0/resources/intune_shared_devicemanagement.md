...
|**deviceManagement**|
|subscriptionState|Zeichenfolge|Mandanten-Mobilgerät-Management-Abonnement-Zustand. Mögliche Werte: `pending`, `active`, `warning`, `disabled`, `deleted`, `blocked`, `lockedOut`.|
|**On-boarding**|
...
|:---|:---|:---|
|**Überwachung**|
|auditEvents|[auditEvent](../resources/intune_auditing_auditevent.md)-Sammlung|Die Überwachungsereignisse|
|**Geschäftsbedingungen im Unternehmen**|
...
|deviceCategories|[deviceCategory](../resources/intune_shared_devicecategory.md)-Sammlung|Die Liste der Gerätekategorien mit den Mandanten.|
