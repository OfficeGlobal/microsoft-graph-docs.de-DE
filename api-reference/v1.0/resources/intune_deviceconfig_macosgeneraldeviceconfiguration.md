...
|compliantAppListType|[appListType](../resources/intune_deviceconfig_applisttype.md)|Liste in der CompliantAppsList. Mögliche Werte: `none`, `appsInListCompliant`, `appsNotInListCompliant`.|
