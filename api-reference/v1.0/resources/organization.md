...
|:---------------|:--------|:----------|
|[organization abrufen](../api/organization_get.md) | [Organisation](organization.md) |Dient zum Lesen der Eigenschaften und der Beziehungen des organization-Objekts.|
|[Aktualisieren](../api/organization_update.md) | [Organisation](organization.md)  |Dient zum Aktualisieren des organization-Objekts. Die einzigen Eigenschaften, die aktualisiert werden können, sind: **marketingNotificationMails**, **technicalNotificationMails**, **securityComplianceNotificationMails**, **securityComplianceNotificationPhones** und **privacyProfile**. |
...
| dirSyncEnabled                       | Boolesch                                                           | **true**, wenn das Objekt aus einem lokalen Verzeichnis synchronisiert wird; **false**, wenn das Objekt ursprünglich aus einem lokalen Verzeichnis synchronisiert wurde, aber nicht mehr synchronisiert wird; **NULL**, wenn dieses Objekt nie aus einem lokalen Verzeichnis synchronisiert wurde (Standard).                        |
| displayName                          | Zeichenfolge                                                            | Der Anzeigename für den Mandanten.                                                                                                                                                                                                                                                     |
| ID                                   | Zeichenfolge                                                            | Der eindeutige Bezeichner für den Mandanten. Geerbt von [directoryObject](directoryobject.md). Key. Lässt keine Nullwerte zu. Schreibgeschützt.                                                                                                                                                            |
...
| Zustand                                | Zeichenfolge                                                            | Der das Bundesland aus der Unternehmensadresse                                                                                                                                                                                                                                       |
| Straße                               | Zeichenfolge                                                            | Der Straßenname aus der Unternehmensadresse                                                                                                                                                                                                                                          |
