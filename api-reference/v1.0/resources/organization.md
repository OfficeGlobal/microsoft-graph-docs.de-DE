...
|[Update](../api/organization_update.md) | [organization](organization.md)  |Dient zum Aktualisieren des organization-Objekts. (Nur die Eigenschaften **marketingNotificationMails** und die **technicalNotificationMails** können aktualisiert werden.) |
...
|:-------------------------------------|:------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| assignedPlans                        | [assignedPlan-Sammlung](assignedplan.md)                        | Die Sammlung von Serviceplänen, die dem Mandanten zugeordnet sind. Lässt keine Nullwerte zu.                                                                                                                                                                                                            |
| city                                 | String                                                            |                                                                                                                                                                                                                                                                                      |
