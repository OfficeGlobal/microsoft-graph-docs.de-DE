...
|[Aktualisieren](../api/plannerbuckettaskboardtaskformat_update.md) | [plannerBucketTaskBoardTaskFormat](plannerbuckettaskboardtaskformat.md)  |Dient zum Aktualisieren des **plannerBucketTaskBoardTaskFormat**-Objekts. |

## <a name="properties"></a>Eigenschaften
| Eigenschaft     | Typ   |Beschreibung|
|:---------------|:--------|:----------|
|ID|Zeichenfolge| Schreibgeschützt. Die ID der Ressource. Sie ist 28 Zeichen lang und berücksichtigt Groß-/Kleinschreibung. Die [Formatvalidierung](planner_identifiers_disclaimer.md) erfolgt für den Dienst.|
|orderHint|Zeichenfolge|Hinweis, der zum Anordnen von Aufgaben in der Ansicht „Buckets“ des Task Board verwendet wird. Das Format ist wie [hier](planner_order_hint_format.md) beschrieben definiert.|
