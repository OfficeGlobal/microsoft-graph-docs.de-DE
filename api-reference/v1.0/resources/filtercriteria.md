...
ms.locfileid: "27019807"
---
# <a name="filtercriteria-resource-type"></a><span data-ttu-id="445cf-103">FilterCriteria-Ressourcentyp</span><span class="sxs-lookup"><span data-stu-id="445cf-103">FilterCriteria resource type</span></span>

<span data-ttu-id="445cf-104">Stellt die auf eine Spalte angewendeten Filterkriterien dar.</span><span class="sxs-lookup"><span data-stu-id="445cf-104">Represents the filtering criteria applied to a column.</span></span>

## <a name="json-representation"></a><span data-ttu-id="445cf-105">JSON-Darstellung</span><span class="sxs-lookup"><span data-stu-id="445cf-105">JSON representation</span></span>

<span data-ttu-id="445cf-106">Es folgt eine JSON-Darstellung der Ressource.</span><span class="sxs-lookup"><span data-stu-id="445cf-106">Here is a JSON representation of the resource.</span></span>
