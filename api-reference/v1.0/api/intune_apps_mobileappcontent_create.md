...
Diese Methode erstellt ein neues Objekt des Typs [mobileAppContent](../resources/intune_apps_mobileappcontent.md).
...
|:---|:---|:---|
|id|String|Version der App-Inhalte|



## <a name="response"></a>Antwort
Bei erfolgreicher Ausführung gibt die Methode den Antwortcode `201 Created` und ein Objekt des Typs [mobileAppContent](../resources/intune_apps_mobileappcontent.md) im Antworttext zurück.
