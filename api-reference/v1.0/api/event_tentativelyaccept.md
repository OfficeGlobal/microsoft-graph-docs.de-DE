# <a name="event-tentativelyaccept"></a>Ereignis: tentativelyAccept

Das angegebene [Ereignis](../resources/event.md) in einem [Kalender](../resources/calendar.md) des Benutzers unter Vorbehalt annehmen.
