...
|autoSubscribeNewMembers|boolesch|Der Standardwert ist **false**. Zeigt an, ob neu zur Gruppe hinzugefügte Mitglieder automatisch E-Mail-Benachrichtigungen erhalten.|
...
|Sichtbarkeit|Zeichenfolge|Gibt die Sichtbarkeit einer Office 365-Gruppe an. Die möglichen Werte sind: **Privat**, **Öffentlich**oder leer (was als **Öffentlich**interpretiert wird).|
