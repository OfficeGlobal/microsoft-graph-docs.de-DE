...
Im nächsten Beispiel wird beim Erstellen des Nachrichtenentwurfs eine Reihe benutzerdefinierter Internet-Nachrichtenköpfe hinzugefügt.
<!-- {
  "blockType": "request",
...
Nachfolgend sehen Sie ein Beispiel der Antwort. Hinweis: Internet-Nachrichtenköpfe werden standardmäßig nicht in einer POST-Antwort zurückgegeben. Das hier gezeigte Antwortobjekt ist aus Platzgründen möglicherweise ebenfalls abgeschnitten. Von einem tatsächlichen Aufruf werden alle Eigenschaften zurückgegeben.
<!-- {
  "blockType": "response",
  "name": "create_message_with_headers_from_user",
  "truncated": true,
