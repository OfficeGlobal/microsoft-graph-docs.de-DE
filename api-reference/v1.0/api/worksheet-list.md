...
---
# <a name="list-worksheetcollection"></a>WorksheetCollection auflisten
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und Auflistung von Objekten im Antworttext [WorkbookWorksheet](../resources/worksheet.md) .
