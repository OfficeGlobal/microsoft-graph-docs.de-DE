...
Diese Methode erstellt ein neues Objekt des Typs [managedDevice](../resources/intune_devices_manageddevice.md).
...
Bei erfolgreicher Ausführung gibt die Methode den Antwortcode `201 Created` und ein Objekt des Typs [managedDevice](../resources/intune_devices_manageddevice.md) im Antworttext zurück.
