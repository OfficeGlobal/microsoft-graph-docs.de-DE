...
---
# <a name="list-points"></a>Punkte auflisten

Dient zum Abrufen einer Liste von chartPoints-Objekten.
...
Wenn die Methode erfolgreich verläuft, werden der Antwortcode `200 OK` und eine Sammlung von [ChartPoints](../resources/chartpoint.md)-Objekten im Antworttext zurückgegeben.
