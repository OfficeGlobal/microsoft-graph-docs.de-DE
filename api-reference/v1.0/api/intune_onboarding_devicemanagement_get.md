...
Lesen von Eigenschaften und Beziehungen des [deviceManagement](../resources/intune_onboarding_devicemanagement.md)-Objekts.
...
Wenn die Methode erfolgreich verläuft, werden der Antwortcode `200 OK` und ein [deviceManagement](../resources/intune_onboarding_devicemanagement.md)-Objekt im Antworttext zurückgegeben.
