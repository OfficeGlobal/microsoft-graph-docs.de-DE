...
---
# <a name="sync-action"></a>sync-Aktion
...
|:---|:---|:---|
|syncType|[deviceManagementExchangeConnectorSyncType](../resources/intune-onboarding-devicemanagementexchangeconnectorsynctype.md)|Typ der auszuführenden Synchronisierung (vollständige Synchronisierung oder Deltasynchronisierung)|
