...
---
# <a name="get-table"></a>Tabelle abrufen

Dient zum Abrufen der Eigenschaften und der Beziehungen des Tabellenobjekts.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und [WorkbookTable](../resources/table.md) -Objekts in der Antworttext.
