...
>**Hinweis:** Verwenden Sie die ID aus der [Liste apps veröffentlicht](./teamsapp_list.md) Aufruf für zurückgegeben, auf um die app zu verweisen, die Sie aktualisieren möchten. Verwenden Sie nicht die in der Manifestdatei der app Zip-Paket-ID ein.
