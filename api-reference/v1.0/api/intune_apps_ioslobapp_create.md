...
Erstellt ein neues [iosLobApp](../resources/intune_apps_ioslobapp.md)-Objekt.
...
Geben Sie im Anforderungstext eine JSON-Darstellung des iosLobApp-Objekts an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der iosLobApp erforderlich sind.
...
Wenn die Methode erfolgreich verläuft, werden der Antwortcode `201 Created` und ein [iosLobApp](../resources/intune_apps_ioslobapp.md)-Objekt im Antworttext zurückgegeben.
