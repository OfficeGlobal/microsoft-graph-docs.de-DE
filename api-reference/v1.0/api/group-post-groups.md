...
## <a name="http-request"></a><span data-ttu-id="d01f1-123">HTTP-Anforderung</span><span class="sxs-lookup"><span data-stu-id="d01f1-123">HTTP request</span></span>
<!-- { "blockType": "ignored" } -->
```http
POST /groups
```
