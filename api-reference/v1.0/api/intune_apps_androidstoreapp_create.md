...
Diese Methode erstellt ein neues Objekt des Typs [androidStoreApp](../resources/intune_apps_androidstoreapp.md).
...
Bei erfolgreicher Ausführung gibt die Methode den Antwortcode `201 Created` und ein Objekt des Typs [androidStoreApp](../resources/intune_apps_androidstoreapp.md) im Antworttext zurück.
