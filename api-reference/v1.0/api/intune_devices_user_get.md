...
Lesen von Eigenschaften und Beziehungen des [user](../resources/intune_devices_user.md)-Objekts.
...
Wenn die Methode erfolgreich verläuft, werden der Antwortcode `200 OK` und ein [user](../resources/intune_devices_user.md)-Objekt im Antworttext zurückgegeben.
