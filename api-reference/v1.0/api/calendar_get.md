...
Es gibt zwei Szenarien, in denen eine App den Kalender eines anderen Benutzers abrufen kann:
...
<!-- { "blockType": "ignored" } --> Der Standard[kalender](../resources/calendar.md) eines Benutzers oder einer Gruppe.
```http
GET /me/calendar
