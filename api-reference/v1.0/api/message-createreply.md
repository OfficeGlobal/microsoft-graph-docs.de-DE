...
Erstellen Sie einen Entwurf der Antwort auf die angegebene [Nachricht](../resources/message.md). Anschließend können Sie den Entwurf [aktualisieren](../api/message-update.md), um den Antwortinhalt zum **Text** hinzuzufügen, oder andere Nachrichteneigenschaften ändern. Sie können den Entwurf auch einfach [senden](../api/message-send.md).
