...
Diese Aktion generiert eine Registrierungs-URL, die zur Registrierung in der Android for Work-Verwaltung verwendet wird.
...
|:---|:---|:---|
|hostName|String|Hostname der Rückruf-URL, auf die der Browser nach dem erfolgreichen Abschluss der Registrierung umgeleitet wird|
