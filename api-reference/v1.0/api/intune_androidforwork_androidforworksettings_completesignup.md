...
Diese Aktion schließt den Fluss zur Registrierung in der Android for Work-Verwaltung ab.
...
|:---|:---|:---|
|enterpriseToken|String|Unternehmenstoken, das nach dem erfolgreichen Abschluss der Registrierung an die Rückruf-URL angefügt wird|
