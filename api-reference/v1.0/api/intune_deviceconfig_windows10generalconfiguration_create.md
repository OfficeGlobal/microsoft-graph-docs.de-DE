...
|defenderCloudBlockLevel|[defenderCloudBlockLevelType](../resources/intune_deviceconfig_defendercloudblockleveltype.md)|Gibt die Ebene des von der Cloud gelieferten Schutzes an. Mögliche Werte: `notConfigured`, `high`, `highPlus`, `zeroTolerance`.|
...
|startMenuPinnedFolderHomeGroup|[visibilitySetting](../resources/intune_deviceconfig_visibilitysetting.md)|Erzwingt die Sichtbarkeit (Ein-/Ausblenden) der Verknüpfung des Ordners HomeGroup-Ordners im Startmenü. Mögliche Werte: `notConfigured`, `hide`, `show`.|
