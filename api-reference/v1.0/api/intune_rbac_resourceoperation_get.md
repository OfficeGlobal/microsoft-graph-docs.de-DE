...
Liest die Eigenschaften und Beziehungen von Objekten des Typs [resourceOperation](../resources/intune_rbac_resourceoperation.md).
...
Wenn die Methode erfolgreich verläuft, werden der Antwortcode `200 OK` und ein [resourceOperation](../resources/intune_rbac_resourceoperation.md)-Objekt im Antworttext zurückgegeben.
