...
Diese Methode erstellt ein neues Objekt des Typs [auditEvent](../resources/intune_auditing_auditevent.md).
...
Bei erfolgreicher Ausführung gibt die Methode den Antwortcode `201 Created` und ein Objekt des Typs [auditEvent](../resources/intune_auditing_auditevent.md) im Antworttext zurück.
