...
Fügt (Pins) einer [Registerkarte](../resources/teamstab.md) an den angegebenen [DDE-Kanal](../resources/channel.md) in einem [Team](../resources/team.md). Die entsprechende app muss bereits [im Team installiert](../api/teamsappinstallation_add.md)sein.
