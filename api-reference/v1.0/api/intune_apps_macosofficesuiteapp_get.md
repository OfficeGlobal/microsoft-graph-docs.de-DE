...
Lesen von Eigenschaften und Beziehungen des [macOSOfficeSuiteApp](../resources/intune_apps_macosofficesuiteapp.md)-Objekts.
...
Wenn die Methode erfolgreich verläuft, werden der Antwortcode `200 OK` und das [macOSOfficeSuiteApp](../resources/intune_apps_macosofficesuiteapp.md)-Objekt im Antworttext zurückgegeben.
