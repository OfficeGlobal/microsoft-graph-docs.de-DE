...
|partnerReportedThreatState|[managedDevicePartnerReportedHealthState](../resources/intune_devices_manageddevicepartnerreportedhealthstate.md)|Gibt den Bedrohungszustand eines Geräts an, wenn ein Mobile Threat Defense-Partner vom Konto und dem Gerät genutzt wird. Nur Lesezugriff. Mögliche Werte: `unknown`, `activated`, `deactivated`, `secured`, `lowSeverity`, `mediumSeverity`, `highSeverity`, `unresponsive`, `compromised`, `misconfigured`.|
