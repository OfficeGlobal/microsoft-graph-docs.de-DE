...
Aktualisieren Sie die Eigenschaften des [Settings](../resources/user_settings.md) -Objekts. Benutzer in derselben Organisation können unterschiedliche Einstellungen basierend auf ihrer Präferenz oder auf den Richtlinien der Organisation verfügen. Um die aktuelle Einstellungen abrufen, finden Sie in der [aktuellen benutzereinstellungen](user_get_settings.md). 
...
Fordern Sie mit einer 'Benutzer-Id"oder"UserPrincipalName"ist nur verfügbar, durch den Benutzer oder von einem Benutzer mit den Berechtigungen User.ReadWrite.All. Weitere Informationen finden Sie unter [Berechtigungen](../../../concepts/permissions_reference.md). 
