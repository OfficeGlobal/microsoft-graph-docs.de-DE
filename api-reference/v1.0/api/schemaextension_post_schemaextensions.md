...
Erstellen Sie eine neue [schemaExtension](../resources/schemaextension.md)-Definition, um einen [unterstützenden Ressourcentyp](../../../concepts/extensibility_overview.md#supported-resources) zu erweitern.

Mit Schemaerweiterungen können Sie stark typisierte benutzerdefinierte Daten zu einer Ressource hinzufügen. Die App, die eine Schemaerweiterung erstellt, ist die Besitzer-App. Abhängig vom [Status](../../../concepts/extensibility_overview.md#schema-extensions-lifecycle) der Erweiterung kann die Besitzer-App, und nur die Besitzer-App, die Erweiterung aktualisieren oder löschen. 
...
|Eigenschaften|[extensionSchemaProperty](../resources/extensionschemaproperty.md)-Sammlung|Die Sammlung von Eigenschaftennamen und Typen, die die Schemaerweiterungsdefinition bilden.|
