...
Dient zum Abrufen der Eigenschaften und des [eventMessage](../resources/eventmessage.md)-Objekts. Wenden Sie den $expand-Parameter auf die **event**-Navigationseigenschaft an, um das zugewiesene [Ereignis](../resources/event.md) im Kalender des Teilnehmers abzurufen.

Zurzeit gibt dieser Vorgang Ereignisnachrichtentext ausschließlich im HTML-Format zurück.
