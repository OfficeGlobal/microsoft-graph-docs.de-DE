...
Nachfolgend sehen Sie ein Beispiel der Anforderung. Es verwendet den `Prefer: outlook.timezone`-Anforderungsheader, um die **Start**- und **End**zeiten in der Antwort anzugeben, die in dieser Zeitzone verwendet werden sollen.
<!-- {
  "blockType": "request",
