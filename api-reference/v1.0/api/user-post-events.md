...
Nachfolgend finden Sie ein Beispiel der Antwort, in der die Eigenschaften **start** und **end** die im `Prefer: outlook.timezone`-Header angegebene Zeitzone verwenden. Hinweis: Das hier gezeigte Antwortobjekt ist möglicherweise aus Platzgründen abgeschnitten. Von einem tatsächlichen Aufruf werden alle Eigenschaften zurückgegeben.
<!-- {
  "blockType": "response",
  "name": "create_event_from_user",
  "truncated": true,
