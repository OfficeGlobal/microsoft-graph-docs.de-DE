...
Mit dieser API können Sie eine Kontaktsammlung aus dem Standardkontaktordner des angemeldeten Benutzers (`.../me/contacts`) oder dem jeweils angegebenen Kontaktordner abrufen.
