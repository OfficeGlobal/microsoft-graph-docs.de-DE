...
Dient zum Abrufen einer Liste von [event](../resources/event.md)-Objekten.
## <a name="prerequisites"></a>Voraussetzungen
Einer der folgenden **Bereiche** ist erforderlich, um diese API auszuführen: _Group.Read.All_ oder _Group.ReadWrite.All_
