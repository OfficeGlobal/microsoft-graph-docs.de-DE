...
|:---------------|:--------|:----------|
|groupIds|Collection von Objekten des Typs „String“|Eine Sammlung mit den Objekt-IDs der Gruppen, in denen die Mitgliedschaft überprüft werden soll. Bis zu 20 Gruppen können angegeben werden.|
