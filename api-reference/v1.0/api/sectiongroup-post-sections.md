...
Erstellen Sie eine neue [OnenoteSection](../resources/section.md) in der angegebenen Abschnittsgruppe aus.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `201 Created` Antwortcode und eines [OnenoteSection](../resources/section.md) -Objekts in der Antworttext.
