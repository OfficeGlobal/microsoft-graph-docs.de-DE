...
Wenn diese Methode erfolgreich verläuft, gibt diese im Antworttext einen `200 OK` Antwortcode und ein [WorkbookTableRow](../resources/tablerow.md)-Objekt zurück.
