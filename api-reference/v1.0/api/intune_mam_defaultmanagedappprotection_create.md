...
|appDataEncryptionType|[managedAppDataEncryptionType](../resources/intune_mam_managedappdataencryptiontype.md)|Typ der Verschlüsselung, die für Daten einer verwalteten App (nur iOS) verwendet werden sollte. Mögliche Werte: `useDeviceSettings`, `afterDeviceRestart`, `whenDeviceLockedExceptOpenFiles`, `whenDeviceLocked`.|
...
|minimumRequiredPatchVersion|Zeichenfolge|Legt das älteste erforderliche Android-Sicherheitspatchlevel fest, mit dem einem Benutzer sicheren Zugriff auf die App gewährt wird. (nur Android)|
...
|faceIdBlocked|Boolesch|Gibt an, ob statt einer PIN die Face ID verwendet werden darf, wenn „pinRequired“ auf Wahr gesetzt ist. (nur iOS)|
