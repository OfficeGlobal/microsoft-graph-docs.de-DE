...
---
# <a name="get-educationuser"></a>EducationUser abrufen

Dient zum Abrufen der Eigenschaften und Beziehungen eines Benutzers.
...
Wenn die Methode erfolgreich verläuft, werden der Antwortcode `200 OK` und ein [educationUser](../resources/educationuser.md)-Objekt im Antworttext zurückgegeben.
