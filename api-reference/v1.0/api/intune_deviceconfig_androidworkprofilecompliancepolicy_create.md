...
Geben Sie im Anforderungstext eine JSON-Darstellung des androidWorkProfileCompliancePolicy-Objekts an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen des androidWorkProfileCompliancePolicy erforderlich sind.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode eine `201 Created` Antwortcode und ein [AndroidWorkProfileCompliancePolicy](../resources/intune_deviceconfig_androidworkprofilecompliancepolicy.md) -Objekt im Antworttext zurück.
