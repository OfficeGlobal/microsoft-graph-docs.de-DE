...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [managedDevice](../resources/intune-devices-manageddevice.md) -Objekt im Antworttext zurück.
