...
Diese Methode listet die Eigenschaften und Beziehungen von Objekten des Typs [managedApp](../resources/intune-apps-managedapp.md) auf.
...
Bei erfolgreicher Ausführung gibt die Methode den Antwortcode `200 OK` und eine Collection von Objekten des Typs [managedApp](../resources/intune-apps-managedapp.md) im Antworttext zurück.
