...
Dient zum Aktualisieren der Eigenschaften des [eventMessage](../resources/eventmessage.md)-Objekts.
...
|:---------------|:--------|:----------|
|categories|Zeichenfolge|Die Kategorien, die mit der Nachricht verknüpft sind.|
