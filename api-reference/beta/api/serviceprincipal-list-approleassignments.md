...
---
# <a name="serviceprincipal-list-approleassignments"></a>ServicePrincipal: AppRoleAssignments auflisten

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Abrufen einer Liste von Approleassignment-Objekten.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und Auflistung von Objekten im Antworttext [AppRoleAssignment](../resources/approleassignment.md) .
