...
In den folgenden Beispielen gezeigt, wie diese API-aufrufen.
...
##### <a name="notification---roster-updated-with-participant-added"></a>Benachrichtigung - Teilnehmerliste aktualisiert mit Teilnehmer hinzugefügt
...
Dieses Beispiel zeigt eine vollständige E2E Ablauf für [Teilnehmer einladen](../api/participant-invite.md) in einer vorhandenen Besprechung P2P.

##### <a name="answer-incoming-voip-call-with-service-hosted-media"></a>Beantworten Sie eingehender VOIP-Anruf mit Medien gehosteten Dienst

##### <a name="notification---incoming"></a>Benachrichtigung - eingehend
...
### <a name="join-channel-meeting-without-media"></a>Teilnehmen an Channel Besprechung ohne Medien
...
### <a name="invite-participant-from-initial-incoming-call"></a>Einladen von Teilnehmern vom ersten eingehenden Anruf
...
##### <a name="notification---terminated-the-original-p2p-call"></a>Benachrichtigung - beendet den ursprünglichen P2P-Anruf
...
##### <a name="notification---deleted-the-original-p2p-call"></a>Benachrichtigung - dem ursprünglichen Anrufer P2P gelöscht
