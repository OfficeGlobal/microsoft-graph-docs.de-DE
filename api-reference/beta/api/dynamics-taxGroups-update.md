...
---
# <a name="update-taxgroups"></a>TaxGroups aktualisieren
Aktualisieren der Eigenschaften eines Steuergruppen Objekts für Dynamics 365 Business Central.
...
Bei erfolgreicher Ausführung gibt diese Methode den `200 OK` Antwortcode und ein aktualisiertes **taxGroups** -Objekt im Antworttext zurück.
