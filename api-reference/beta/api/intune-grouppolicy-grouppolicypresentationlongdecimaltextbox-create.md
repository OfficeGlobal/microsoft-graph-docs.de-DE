...
---
# <a name="create-grouppolicypresentationlongdecimaltextbox"></a>Erstellen von groupPolicyPresentationLongDecimalTextBox
...
Geben Sie im Textkörper Anforderung für das Objekt GroupPolicyPresentationLongDecimalTextBox eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die GroupPolicyPresentationLongDecimalTextBox erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `201 Created` Antwortcode und eines [GroupPolicyPresentationLongDecimalTextBox](../resources/intune-grouppolicy-grouppolicypresentationlongdecimaltextbox.md) -Objekts in der Antworttext.
