...
---
# <a name="update-shipmentmethods"></a>ShipmentMethods aktualisieren
Aktualisieren der Eigenschaften eines Transportmethoden Objekts für Dynamics 365 Business Central.
...
Bei erfolgreicher Ausführung gibt diese Methode den `200 OK` Antwortcode und ein aktualisiertes **shipmentMethods** -Objekt im Antworttext zurück.
