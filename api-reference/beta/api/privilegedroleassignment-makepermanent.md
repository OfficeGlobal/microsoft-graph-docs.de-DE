...
Der Mandant muss auf den PIM registriert werden. Andernfalls wird HTTP 403 Verboten Fehler zurückgegeben.
...
|ticketNumber|string|Optional. Die Anzahl der Ticket, die diese Aktion zugeordnet ist.|
