...
Abrufen einer bestimmten Übermittlung an. Eine Übermittlung-Objekt stellt einen Schüler Arbeit für eine Zuordnung dar. Ressourcen im Zusammenhang mit der Übermittlung darstellen diese arbeiten. Nur der Student, die Übermittlung zugewiesen ist, kann finden Sie unter und die Übermittlung geändert werden. Lehrer verfügt über Vollzugriff auf alle Übermittlungen. 

Die Qualität und Feedback von Lehrer sind ebenfalls Teil dieses Objekt. Nur Lehrer können hinzufügen oder Ändern von Kategorien und Feedback. Studenten werden nicht angezeigt, der Kategorie oder Feedback, bis die Zuordnung freigegeben wurde. Die grundlegenden Berechtigungen Note und Feedback keinen aber alles einschließen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode eine `200 OK` Antwortcode und eines [EducationSubmission](../resources/educationsubmission.md) -Objekts in der Antworttext.
