...
---
# <a name="create-ioswificonfiguration"></a>IosWiFiConfiguration erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das iosWiFiConfiguration-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der iosWiFiConfiguration erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [iosWiFiConfiguration](../resources/intune-deviceconfig-ioswificonfiguration.md) -Objekt im Antworttext zurück.
