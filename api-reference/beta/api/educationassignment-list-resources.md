...
Rufen Sie alle Ressourcen, die diese Zuordnung zugeordnet.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eine Auflistung von Objekten im Antworttext [EducationAssignmentResource](../resources/educationassignmentresource.md) .
