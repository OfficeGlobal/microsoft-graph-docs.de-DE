...
Abrufen einer Liste der [PlannerPlans](../resources/plannerplan.md) , die von einem Benutzer als bevorzugten gekennzeichnet sind. Sie können einen Plan als bevorzugten durch [Aktualisieren der Ressource PlannerUser](planneruser-update.md)markieren.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eine Auflistung von Objekten im Antworttext [PlannerPlan](../resources/plannerplan.md) .
