...
---
# <a name="create-employees"></a>Mitarbeiter erstellen
Erstellen Sie ein Employee-Objekt in Dynamics 365 Business Central.
...
Geben Sie im Anforderungstext eine JSON-Darstellung eines **Employees** -Objekts an.

## <a name="response"></a>Antwort
Bei erfolgreicher Ausführung gibt diese Methode ```201 Created``` den Antwortcode und **** ein Employees-Objekt im Antworttext zurück.
