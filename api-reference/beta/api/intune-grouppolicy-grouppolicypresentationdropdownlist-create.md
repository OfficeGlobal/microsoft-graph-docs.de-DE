...
---
# <a name="create-grouppolicypresentationdropdownlist"></a>GroupPolicyPresentationDropdownList erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das groupPolicyPresentationDropdownList-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der groupPolicyPresentationDropdownList erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [groupPolicyPresentationDropdownList](../resources/intune-grouppolicy-grouppolicypresentationdropdownlist.md) -Objekt im Antworttext zurück.
