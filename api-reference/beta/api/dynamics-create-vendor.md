...
---
# <a name="create-vendors"></a>Kreditoren erstellen
Erstellen Sie ein Vendor-Objekt in Dynamics 365 Business Central.
...
Geben Sie im Anforderungstext eine JSON-Darstellung eines **vendors** -Objekts an.

## <a name="response"></a>Antwort
Bei erfolgreicher Ausführung gibt diese Methode ```201 Created``` den Antwortcode und **** ein vendors-Objekt im Antworttext zurück.
