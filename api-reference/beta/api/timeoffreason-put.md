...
---
# <a name="replace-timeoffreason"></a>TimeOffReason ersetzen

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Ersetzen eines vorhandenen [timeOffReason](../resources/timeoffreason.md).

Wenn die angegebene [timeOffReason](../resources/timeoffreason.md) nicht vorhanden ist, gibt diese `404 Not found`Methode zurück.
...
Geben Sie im Anforderungstext eine JSON-Darstellung eines [timeOffReason](../resources/timeoffreason.md) -Objekts an.
