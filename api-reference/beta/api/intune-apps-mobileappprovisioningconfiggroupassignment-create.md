...
Geben Sie im Anforderungstext eine JSON-Darstellung für das mobileAppProvisioningConfigGroupAssignment-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der mobileAppProvisioningConfigGroupAssignment erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [mobileAppProvisioningConfigGroupAssignment](../resources/intune-apps-mobileappprovisioningconfiggroupassignment.md) -Objekt im Antworttext zurück.
