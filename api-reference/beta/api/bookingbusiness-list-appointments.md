...
---
# <a name="list-appointments"></a>Liste Termine

 > **Wichtig:** Die APIs der /Beta-Version in Microsoft Graph befinden sich in der Vorschau und können Änderungen unterliegen. Die Verwendung dieser APIs in Produktionsanwendungen wird nicht unterstützt.
 
Rufen Sie eine Liste von [BookingAppointment](../resources/bookingappointment.md) -Objekten für den angegebenen [Bookingbusiness](../resources/bookingbusiness.md).
...
Zum Abrufen der Reihe von Terminen eines Unternehmens Buchungen innerhalb eines Datumsbereichs anstelle von `$filter`, für diesen Datumsbereich [das CalendarView erhalten möchten](bookingbusiness-list-calendarview.md) . 
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und Auflistung von Objekten im Antworttext [BookingAppointment](../resources/bookingappointment.md) .
