...
Aktualisieren der Eigenschaften eines [macOSLobApp](../resources/intune-apps-macoslobapp.md) -Objekts.
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das [macOSLobApp](../resources/intune-apps-macoslobapp.md) -Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der [macOSLobApp](../resources/intune-apps-macoslobapp.md)erforderlich sind.
...
|bundleId|String|Die Bundle-ID.|
|minimumSupportedOperatingSystem|[macOSMinimumOperatingSystem](../resources/intune-apps-macosminimumoperatingsystem.md)|Der Wert für die Mindestversion des verwendbaren Betriebssystems.|
|buildNumber|String|Die Buildnummer der MacOS-app.|
|versionNumber|String|Die Versionsnummer der MacOS-app.|
...
Bei erfolgreicher Ausführung gibt diese Methode den `200 OK` Antwortcode und ein aktualisiertes [macOSLobApp](../resources/intune-apps-macoslobapp.md) -Objekt im Antworttext zurück.
