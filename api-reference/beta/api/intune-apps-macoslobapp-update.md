...
Aktualisieren Sie die Eigenschaften eines [MacOSLobApp](../resources/intune-apps-macoslobapp.md) -Objekts.
...
In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die [MacOSLobApp](../resources/intune-apps-macoslobapp.md)erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eine aktualisierte [MacOSLobApp](../resources/intune-apps-macoslobapp.md) -Objekts in der Antworttext.
