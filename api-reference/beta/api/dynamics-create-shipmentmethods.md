...
---
# <a name="create-shipmentmethods"></a>ShipmentMethods erstellen
Erstellen Sie ein Transportmethode-Objekt in Dynamics 365 Business Central.
...
Geben Sie im Anforderungstext eine JSON-Darstellung eines **shipmentMethods** -Objekts an.

## <a name="response"></a>Antwort
Bei erfolgreicher Ausführung gibt diese Methode ```201 Created``` den Antwortcode und ein **shipmentMethods** -Objekt im Antworttext zurück.
