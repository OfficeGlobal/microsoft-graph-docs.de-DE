...
Geben Sie im Anforderungstext eine JSON-Darstellung für das macOSScepCertificateProfile-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der macOSScepCertificateProfile erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [macOSScepCertificateProfile](../resources/intune-deviceconfig-macosscepcertificateprofile.md) -Objekt im Antworttext zurück.
