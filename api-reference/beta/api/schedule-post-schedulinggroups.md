...
---
# <a name="create-schedulinggroup"></a>Planungsgroup erstellen

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Erstellen Sie eine [](../resources/schedulinggroup.md)neue schedulinggroup.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [schedulinggroup](../resources/schedulinggroup.md) -Objekt im Antworttext zurück.
