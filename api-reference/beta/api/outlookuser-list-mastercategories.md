...
---
# <a name="list-outlook-categories"></a>Auflisten von Outlook-Kategorien
...
Ruft alle Kategorien ab, die für den Benutzer definiert wurden.
...
Bei erfolgreicher Ausführung gibt die Methode den Antwortcode `200 OK` und eine Sammlung von [outlookCategory](../resources/outlookcategory.md)-Objekten im Antworttext zurück.
