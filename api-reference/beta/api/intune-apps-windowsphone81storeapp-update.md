...
Aktualisieren der Eigenschaften eines [windowsPhone81StoreApp](../resources/intune-apps-windowsphone81storeapp.md) -Objekts.
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das [windowsPhone81StoreApp](../resources/intune-apps-windowsphone81storeapp.md) -Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der [windowsPhone81StoreApp](../resources/intune-apps-windowsphone81storeapp.md)erforderlich sind.
...
|appStoreUrl|Zeichenfolge|Die URL des Windows Phone 8,1-APP-Speichers.|



## <a name="response"></a>Antwort
Bei erfolgreicher Ausführung gibt diese Methode den `200 OK` Antwortcode und ein aktualisiertes [windowsPhone81StoreApp](../resources/intune-apps-windowsphone81storeapp.md) -Objekt im Antworttext zurück.
