...
---
# <a name="create-androidforworkvpnconfiguration"></a>Erstellen von androidForWorkVpnConfiguration
...
Geben Sie im Textkörper Anforderung für das Objekt AndroidForWorkVpnConfiguration eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die AndroidForWorkVpnConfiguration erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `201 Created` Antwortcode und eines [AndroidForWorkVpnConfiguration](../resources/intune-deviceconfig-androidforworkvpnconfiguration.md) -Objekts in der Antworttext.
