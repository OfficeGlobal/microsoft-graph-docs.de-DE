...
Aktualisieren Sie die Eigenschaften eines [AppLogCollectionRequest](../resources/intune-devices-applogcollectionrequest.md) -Objekts.
...
Geben Sie im Textkörper Anforderung für das Objekt [AppLogCollectionRequest](../resources/intune-devices-applogcollectionrequest.md) eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die [AppLogCollectionRequest](../resources/intune-devices-applogcollectionrequest.md)erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eine aktualisierte [AppLogCollectionRequest](../resources/intune-devices-applogcollectionrequest.md) -Objekts in der Antworttext.
