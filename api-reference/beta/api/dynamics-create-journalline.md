...
---
# <a name="create-journallines"></a>JournalLines erstellen
Erstellt ein Journal Zeile-Objekt in Dynamics 365 Business Central.
...
Geben Sie im Anforderungstext eine JSON-Darstellung des **journalLines** -Objekts an.

## <a name="response"></a>Antwort
Bei erfolgreicher Ausführung gibt diese Methode ```201 Created``` den Antwortcode und das **journalLines** -Objekt im Antworttext zurück.
