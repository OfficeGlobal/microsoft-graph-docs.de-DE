...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und aktualisierte [WorkbookChartLineFormat](../resources/chartlineformat.md) -Objekts in der Antworttext.
