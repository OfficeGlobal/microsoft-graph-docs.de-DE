...
---
# <a name="replace-schedulinggroup"></a>Ersetzen von schedulinggroup

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Ersetzen Sie eine [](../resources/schedulinggroup.md)vorhandene schedulinggroup.

Wenn die angegebene [schedulinggroup](../resources/schedulinggroup.md) nicht vorhanden ist, gibt diese `404 Not found`Methode zurück.
...
Geben Sie im Anforderungstext eine JSON-Darstellung eines [schedulinggroup](../resources/schedulinggroup.md) -Objekts an.
