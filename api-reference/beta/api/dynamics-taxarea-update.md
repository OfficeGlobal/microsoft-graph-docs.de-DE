...
---
# <a name="update-taxareas"></a>TaxAreas aktualisieren
Aktualisieren der Eigenschaften eines Steuerbereichs Objekts für Dynamics 365 Business Central.
...
Bei erfolgreicher Ausführung gibt diese Methode den `200 OK` Antwortcode und ein aktualisiertes **taxAreas** -Objekt im Antworttext zurück.
