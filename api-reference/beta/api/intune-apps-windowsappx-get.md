...
Lesen Sie Eigenschaften und Beziehungen des [WindowsAppX](../resources/intune-apps-windowsappx.md) -Objekts.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortobjekt Code und [WindowsAppX](../resources/intune-apps-windowsappx.md) im Antworttext.
