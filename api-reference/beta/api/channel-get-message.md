...
Rufen Sie eine [Nachricht](../resources/chatmessage.md) (ohne die Antworten) in einem [Kanal](../resources/channel.md) eines Teams ab.
...
>**Hinweis:** Das hier gezeigte Antwortobjekt werden zur besseren Lesbarkeit gekürzt. Ein tatsächlicher Aufruf gibt alle Eigenschaften zurück.
<!-- {
  "blockType": "response",
  "truncated": true,
