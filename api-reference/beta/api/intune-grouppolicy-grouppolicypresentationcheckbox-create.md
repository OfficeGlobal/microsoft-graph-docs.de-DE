...
---
# <a name="create-grouppolicypresentationcheckbox"></a>Erstellen von groupPolicyPresentationCheckBox
...
Geben Sie im Textkörper Anforderung für das Objekt GroupPolicyPresentationCheckBox eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die GroupPolicyPresentationCheckBox erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `201 Created` Antwortcode und eines [GroupPolicyPresentationCheckBox](../resources/intune-grouppolicy-grouppolicypresentationcheckbox.md) -Objekts in der Antworttext.
