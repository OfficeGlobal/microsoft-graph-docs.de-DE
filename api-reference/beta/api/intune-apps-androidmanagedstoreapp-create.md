...
---
# <a name="create-androidmanagedstoreapp"></a>Erstellen von androidManagedStoreApp
...
Geben Sie im Textkörper Anforderung für das Objekt AndroidManagedStoreApp eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die AndroidManagedStoreApp erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `201 Created` Antwortcode und eines [AndroidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md) -Objekts in der Antworttext.
