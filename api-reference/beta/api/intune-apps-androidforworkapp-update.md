...
---
# <a name="update-androidforworkapp"></a>AndroidForWorkApp aktualisieren

> **Wichtig:** Microsoft Graph-APIs unter der/Beta-Version können geändert werden; die Produktion wird nicht unterstützt.

> **Hinweis:** Die Microsoft Graph-API für InTune benötigt eine [aktive INTUNE-Lizenz](https://go.microsoft.com/fwlink/?linkid=839381) für den Mandanten.

Aktualisieren der Eigenschaften eines [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) -Objekts.
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) -Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der [androidForWorkApp](../resources/intune-apps-androidforworkapp.md)erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `200 OK` Antwortcode und ein aktualisiertes [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) -Objekt im Antworttext zurück.
