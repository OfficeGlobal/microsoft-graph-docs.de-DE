...
---
# <a name="create-grouppolicypresentationdecimaltextbox"></a>Erstellen von groupPolicyPresentationDecimalTextBox
...
Geben Sie im Textkörper Anforderung für das Objekt GroupPolicyPresentationDecimalTextBox eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die GroupPolicyPresentationDecimalTextBox erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `201 Created` Antwortcode und eines [GroupPolicyPresentationDecimalTextBox](../resources/intune-grouppolicy-grouppolicypresentationdecimaltextbox.md) -Objekts in der Antworttext.
