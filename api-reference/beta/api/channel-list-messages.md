...
---
# <a name="list-channel-messages"></a>Kanalnachrichten auflisten

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Ruft die Liste der [Nachrichten](../resources/chatmessage.md) (ohne die Antworten) in einem [Kanal](../resources/channel.md) eines [Teams](../resources/team.md) ab. Um die Antworten für eine Nachricht abzurufen, rufen Sie die API zum [Auflisten der Nachrichtenantworten](channel-get-messagereply.md) oder die API zum [Abrufen der Nachrichtenantwort](channel-list-messagereplies.md) auf. 
