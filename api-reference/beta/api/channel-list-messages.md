...
Abrufen der Liste der [Nachrichten](../resources/chatmessage.md) (ohne die Antworten) in einem [Kanal](../resources/channel.md) , der ein [Team](../resources/team.md). Wenn die Antworten für eine Nachricht erhalten möchten, rufen Sie die [Liste an Antworten](channel-get-messagereply.md) oder [Antwort erhalten](channel-list-messagereplies.md) API. 
