...
---
# <a name="get-officeclientconfiguration"></a>Für abrufen
...
Bei erfolgreicher Ausführung gibt die Methode den `200 OK` Antwortcode und das [für](../resources/intune-cirrus-officeclientconfiguration.md) -Objekt im Antworttext zurück.
