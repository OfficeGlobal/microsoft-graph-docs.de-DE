...
---
# <a name="get-application"></a>Anwendung abrufen

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Dient zum Abrufen der Eigenschaften und der Beziehungen des Anwendungsobjekts.
...
Wenn die Methode erfolgreich verläuft, werden der Antwortcode `200 OK` und ein [application](../resources/application.md)-Objekt im Antworttext zurückgegeben.
