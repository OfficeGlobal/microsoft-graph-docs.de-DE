...
---
# <a name="get-customerpaymentjournals"></a>CustomerPaymentJournals abrufen
Dient zum Abrufen der Eigenschaften und Beziehungen eines Kunden-Zahlungsjournal Objekts für Dynamics 365 Business Central.
...
Bei erfolgreicher Ausführung gibt diese Methode den `200 OK` Antwortcode und ein **customerPaymentJournals** -Objekt im Antworttext zurück.
