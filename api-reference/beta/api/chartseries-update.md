...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und aktualisierte [WorkbookChartSeries](../resources/chartseries.md) -Objekts in der Antworttext.
