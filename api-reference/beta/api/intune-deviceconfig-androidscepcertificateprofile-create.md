...
---
# <a name="create-androidscepcertificateprofile"></a>Erstellen von androidScepCertificateProfile
...
Geben Sie im Textkörper Anforderung für das Objekt AndroidScepCertificateProfile eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die AndroidScepCertificateProfile erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `201 Created` Antwortcode und eines [AndroidScepCertificateProfile](../resources/intune-deviceconfig-androidscepcertificateprofile.md) -Objekts in der Antworttext.
