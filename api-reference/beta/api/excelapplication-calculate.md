...
---
# <a name="application-calculate"></a>Anwendung: berechnen
...
|:---------------|:--------|:----------|
|calculationType|string|Gibt den Berechnungstyp verwendet.  Mögliche Werte sind: `Recalculate`, `Full` und `FullRebuild`.|
