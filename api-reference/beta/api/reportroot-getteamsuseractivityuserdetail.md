...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eines **[TeamsUserActivityUserDetail](../resources/teamsuseractivityuserdetail.md)** -Objekts in der Antworttext.
