...
---
# <a name="list-applications"></a>Anwendungen auflisten

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Abrufen der Liste von Anwendungen in dieser Organisation.
...
Wenn die Methode erfolgreich verläuft, werden der Antwortcode `200 OK` und eine Sammlung von [section](../resources/application.md)-Objekten im Antworttext zurückgegeben.
