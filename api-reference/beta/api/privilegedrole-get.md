...
---
# <a name="get-privilegedrole"></a>Abrufen von privilegedRole

> **Wichtig:** Die APIs der /Beta-Version in Microsoft Graph befinden sich in der Vorschau und können Änderungen unterliegen. Die Verwendung dieser APIs in Produktionsanwendungen wird nicht unterstützt.

Rufen Sie die Eigenschaften und Beziehungen des [PrivilegedRole](../resources/privilegedrole.md) -Objekts ab. 
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortobjekt Code und [PrivilegedRole](../resources/privilegedrole.md) im Antworttext.
