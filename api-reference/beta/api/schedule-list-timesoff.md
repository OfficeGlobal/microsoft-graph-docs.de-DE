...
---
# <a name="list-timesoff"></a>TimesOff aufListen

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Rufen Sie die Liste der [timeOff](../resources/timeoff.md) -Instanzen in einem [Zeitplan](../resources/schedule.md)ab.
...
Bei erfolgreicher Ausführung gibt die Methode den `200 OK` Antwortcode und eine Sammlung von [timeOff](../resources/timeoff.md) -Objekten im Antworttext zurück.

## <a name="example"></a>Beispiel

#### <a name="request"></a>Anforderung

Nachfolgend sehen Sie ein Beispiel für eine Anforderung, die alle **timeOff** -Objekte mit einer freigegebenen Version und einer Entwurfsversion zwischen dem 11. März 2019.
<!-- {
  "blockType": "request",
