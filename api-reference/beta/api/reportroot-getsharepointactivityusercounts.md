...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eines **[SharePointActivityUserCounts](../resources/sharepointactivityusercounts.md)** -Objekts in der Antworttext.
