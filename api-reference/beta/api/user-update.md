...
Da die **Benutzer** Ressource [Erweiterungen](/graph/extensibility-overview)unterstützt, können Sie den `PATCH` Vorgang verwenden, um eigene APP-spezifische Daten in benutzerdefinierten Eigenschaften einer Erweiterung in einer vorhandenen **Benutzer** Instanz hinzuzufügen, zu aktualisieren oder zu löschen.
