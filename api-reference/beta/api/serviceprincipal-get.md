...
Wenn die Methode erfolgreich verläuft, werden der Antwortcode `200 OK` und ein [servicePrincipal](../resources/serviceprincipal.md)-Objekt im Antworttext zurückgegeben.
