...
---
# <a name="create-userappinstallstatus"></a>UserAppInstallStatus erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das userAppInstallStatus-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der userAppInstallStatus erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [userAppInstallStatus](../resources/intune-apps-userappinstallstatus.md) -Objekt im Antworttext zurück.
