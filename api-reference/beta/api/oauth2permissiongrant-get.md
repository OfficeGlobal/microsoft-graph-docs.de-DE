...
---
# <a name="get-oauth2permissiongrant"></a>Abrufen von oAuth2Permissiongrant

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Rufen Sie die Eigenschaften und Beziehungen des oAuth2Permissiongrant-Objekts ab.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortobjekt Code und [oAuth2Permissiongrant](../resources/oauth2permissiongrant.md) im Antworttext.
