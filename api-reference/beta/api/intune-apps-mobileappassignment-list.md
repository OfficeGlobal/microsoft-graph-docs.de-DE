...
Diese Methode listet die Eigenschaften und Beziehungen von Objekten des Typs [mobileAppAssignment](../resources/intune-apps-mobileappassignment.md) auf.
...
Bei erfolgreicher Ausführung gibt die Methode den Antwortcode `200 OK` und eine Collection von Objekten des Typs [mobileAppAssignment](../resources/intune-apps-mobileappassignment.md) im Antworttext zurück.
