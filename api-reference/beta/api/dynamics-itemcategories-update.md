...
---
# <a name="update-itemcategories"></a>ItemCategories aktualisieren
Aktualisieren der Eigenschaften eines Item Category-Objekts für Dynamics 365 Business Central.
...
Bei erfolgreicher Ausführung gibt diese Methode den `200 OK` Antwortcode und ein aktualisiertes **itemCategories** -Objekt im Antworttext zurück.
