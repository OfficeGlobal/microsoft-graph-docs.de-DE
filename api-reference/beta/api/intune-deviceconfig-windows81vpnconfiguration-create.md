...
---
# <a name="create-windows81vpnconfiguration"></a>Windows81VpnConfiguration erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das windows81VpnConfiguration-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der windows81VpnConfiguration erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [windows81VpnConfiguration](../resources/intune-deviceconfig-windows81vpnconfiguration.md) -Objekt im Antworttext zurück.
