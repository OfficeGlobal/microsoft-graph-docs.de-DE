...
---
# <a name="create-countriesregions"></a>CountriesRegions erstellen
Erstellen Sie ein countriesRegions-Objekt in Dynamics 365 Business Central.
...
Geben Sie im Anforderungstext eine JSON-Darstellung des **countriesRegions** -Objekts an.

## <a name="response"></a>Antwort
Bei erfolgreicher Ausführung gibt diese Methode ```201 Created``` den Antwortcode und ein **countriesRegions** -Objekt im Antworttext zurück.
