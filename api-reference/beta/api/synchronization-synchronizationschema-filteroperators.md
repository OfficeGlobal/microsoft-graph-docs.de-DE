...
Alle in den [Gültigkeitsbereichen Filter](../resources/synchronization-filter.md)unterstützte Operatoren aufgelistet.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200, OK` Antwortcode und ein [FilterOperatorSchema](../resources/synchronization-filteroperatorschema.md) -Auflistungsobjekt in der Antworttext.
