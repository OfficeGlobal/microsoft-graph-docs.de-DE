...
---
# <a name="update-androidmanagedstoreapp"></a>AndroidManagedStoreApp aktualisieren

> **Wichtig:** Microsoft Graph-APIs unter der/Beta-Version können geändert werden; die Produktion wird nicht unterstützt.

> **Hinweis:** Die Microsoft Graph-API für InTune benötigt eine [aktive INTUNE-Lizenz](https://go.microsoft.com/fwlink/?linkid=839381) für den Mandanten.

Aktualisieren der Eigenschaften eines [androidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md) -Objekts.
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das [androidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md) -Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der [androidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md)erforderlich sind.
...
|appStoreUrl|String|Die App-URL für die Wiedergabe für Arbeitsspeicher.|
|supportsOemConfig|Boolescher Wert|Ob diese APP die OEMConfig-Richtlinie unterstützt.|



## <a name="response"></a>Antwort
Bei erfolgreicher Ausführung gibt diese Methode den `200 OK` Antwortcode und ein aktualisiertes [androidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md) -Objekt im Antworttext zurück.
