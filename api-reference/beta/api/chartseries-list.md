...
---
# <a name="list-chartseriescollection"></a>ChartSeriesCollection auflisten

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Dient zum Abrufen einer Liste von chartseries-Objekten.
...
Wenn die Methode erfolgreich verläuft, werden der Antwortcode `200 OK` und eine Sammlung von [ChartSeries](../resources/chartseries.md)-Objekten im Antworttext zurückgegeben.
