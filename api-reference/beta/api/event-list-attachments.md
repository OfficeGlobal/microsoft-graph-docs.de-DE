...
Insbesondere, können Sie mithilfe der `$expand` Abfragen Parameter, um alle für das Ereignis Anlagen Inline mit dem Rest der Ereigniseigenschaften enthalten. Beispiel:
