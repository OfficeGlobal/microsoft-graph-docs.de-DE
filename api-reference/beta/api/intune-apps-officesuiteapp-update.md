...
Aktualisieren der Eigenschaften eines [officeSuiteApp](../resources/intune-apps-officesuiteapp.md) -Objekts.
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das [officeSuiteApp](../resources/intune-apps-officesuiteapp.md) -Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der [officeSuiteApp](../resources/intune-apps-officesuiteapp.md)erforderlich sind.
...
|productIds|[officeProductId](../resources/intune-apps-officeproductid.md) -Sammlung|Die Produkt-IDs, die die SKU der Office365-Suite darstellen. Mögliche Werte sind: `o365ProPlusRetail`, `o365BusinessRetail`, `visioProRetail` und `projectProRetail`.|
...
Bei erfolgreicher Ausführung gibt diese Methode den `200 OK` Antwortcode und ein aktualisiertes [officeSuiteApp](../resources/intune-apps-officesuiteapp.md) -Objekt im Antworttext zurück.
