...
---
# <a name="create-grouppolicypresentationvalueboolean"></a>Erstellen von groupPolicyPresentationValueBoolean
...
Geben Sie im Textkörper Anforderung für das Objekt GroupPolicyPresentationValueBoolean eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die GroupPolicyPresentationValueBoolean erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `201 Created` Antwortcode und eines [GroupPolicyPresentationValueBoolean](../resources/intune-grouppolicy-grouppolicypresentationvalueboolean.md) -Objekts in der Antworttext.
