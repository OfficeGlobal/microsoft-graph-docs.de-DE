...
---
# <a name="update-unitsofmeasure"></a>UnitsOfMeasure aktualisieren
Aktualisieren der Eigenschaften eines Maßeinheits Objekts für Dynamics 365 Business Central.
...
Bei erfolgreicher Ausführung gibt diese Methode den `200 OK` Antwortcode und ein aktualisiertes **unitsOfMeasure** -Objekt im Antworttext zurück.
