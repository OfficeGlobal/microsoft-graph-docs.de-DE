...
---
# <a name="create-androidworkprofileenterprisewificonfiguration"></a>AndroidWorkProfileEnterpriseWiFiConfiguration erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das androidWorkProfileEnterpriseWiFiConfiguration-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der androidWorkProfileEnterpriseWiFiConfiguration erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [androidWorkProfileEnterpriseWiFiConfiguration](../resources/intune-deviceconfig-androidworkprofileenterprisewificonfiguration.md) -Objekt im Antworttext zurück.
