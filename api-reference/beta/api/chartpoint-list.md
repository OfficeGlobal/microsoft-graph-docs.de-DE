...
Dient zum Abrufen einer Liste von ChartPoint-Objekten.
...
Wenn die Methode erfolgreich verläuft, werden der Antwortcode `200 OK` und eine Sammlung von [ChartPoint](../resources/chartpoint.md)-Objekten im Antworttext zurückgegeben.
