...
---
# <a name="create-applevpptokentroubleshootingevent"></a>AppleVppTokenTroubleshootingEvent erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das appleVppTokenTroubleshootingEvent-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der appleVppTokenTroubleshootingEvent erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [appleVppTokenTroubleshootingEvent](../resources/intune-troubleshooting-applevpptokentroubleshootingevent.md) -Objekt im Antworttext zurück.
