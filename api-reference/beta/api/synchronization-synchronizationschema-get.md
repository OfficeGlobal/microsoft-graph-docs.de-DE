...
---
# <a name="get-synchronizationschema"></a>Abrufen von synchronizationSchema

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Rufen Sie das Schema für einen bestimmten Synchronisierungsauftrag oder eine Vorlage.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eines [SynchronizationSchema](../resources/synchronization-synchronizationschema.md) -Objekts in der Antworttext.
