...
---
# <a name="create-androidforworkpkcscertificateprofile"></a>Erstellen von androidForWorkPkcsCertificateProfile
...
Geben Sie im Textkörper Anforderung für das Objekt AndroidForWorkPkcsCertificateProfile eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die AndroidForWorkPkcsCertificateProfile erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `201 Created` Antwortcode und eines [AndroidForWorkPkcsCertificateProfile](../resources/intune-deviceconfig-androidforworkpkcscertificateprofile.md) -Objekts in der Antworttext.
