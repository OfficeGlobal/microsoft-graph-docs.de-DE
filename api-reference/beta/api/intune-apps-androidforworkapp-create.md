...
---
# <a name="create-androidforworkapp"></a>AndroidForWorkApp erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das androidForWorkApp-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der androidForWorkApp erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) -Objekt im Antworttext zurück.
