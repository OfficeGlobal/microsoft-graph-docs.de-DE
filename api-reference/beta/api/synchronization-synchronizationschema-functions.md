...
---
# <a name="synchronizationschema-functions"></a>SynchronizationSchema: Funktionen

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Listen Sie alle Funktionen, die derzeit in der [AttributeMappingSource](../resources/synchronization-attributemappingsource.md)unterstützt.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eine Auflistung von Objekten im Antworttext [AttributemappingFunctionSchema](../resources/synchronization-attributemappingfunctionschema.md) .
