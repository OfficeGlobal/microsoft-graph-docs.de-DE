...
Rufen Sie die Eigenschaften und die Beziehungen eines [PlannerUser](../resources/planneruser.md) -Objekts ab. Die zurückgegebenen Eigenschaften des Benutzers bevorzugten Pläne enthalten und zuletzt angezeigte Pläne. 
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eines [PlannerUser](../resources/planneruser.md) -Objekts in der Antworttext.
