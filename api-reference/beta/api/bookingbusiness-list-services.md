...
Rufen Sie eine Liste der [BookingService](../resources/bookingservice.md) -Objekte in der angegebenen [Bookingbusiness](../resources/bookingbusiness.md).
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und Auflistung von Objekten im Antworttext [BookingService](../resources/bookingservice.md) .
