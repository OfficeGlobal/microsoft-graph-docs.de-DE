...
---
# <a name="list-synchronization-jobs"></a>Liste Aufträge für die Synchronisierung

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Vorhandene Aufträge für eine Instanz einer Anwendung (Service Principal) auflisten.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eine Auflistung von Objekten im Antworttext [SynchronizationJob](../resources/synchronization-synchronizationjob.md) .
