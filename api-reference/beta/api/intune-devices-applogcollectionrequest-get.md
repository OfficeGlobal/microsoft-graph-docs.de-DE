...
---
# <a name="get-applogcollectionrequest"></a>Abrufen von appLogCollectionRequest

> **Wichtig:** APIs unter der /beta Version von Microsoft Graph werden können geändert. Die Verwendung dieser APIs in Produktionsanwendungen wird nicht unterstützt.

> **Hinweis:** Die Microsoft Graph-API für Intune ist eine [aktive Intune-Lizenz](https://go.microsoft.com/fwlink/?linkid=839381) für den Mandanten erforderlich.

Lesen Sie Eigenschaften und Beziehungen des [AppLogCollectionRequest](../resources/intune-devices-applogcollectionrequest.md) -Objekts.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortobjekt Code und [AppLogCollectionRequest](../resources/intune-devices-applogcollectionrequest.md) im Antworttext.
