...
---
# <a name="list-grouppolicypresentationvaluetexts"></a>Liste groupPolicyPresentationValueTexts
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eine Auflistung von Objekten im Antworttext [GroupPolicyPresentationValueText](../resources/intune-grouppolicy-grouppolicypresentationvaluetext.md) .
