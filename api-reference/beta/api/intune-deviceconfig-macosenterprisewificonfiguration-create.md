...
---
# <a name="create-macosenterprisewificonfiguration"></a>MacOSEnterpriseWiFiConfiguration erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das macOSEnterpriseWiFiConfiguration-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der macOSEnterpriseWiFiConfiguration erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [macOSEnterpriseWiFiConfiguration](../resources/intune-deviceconfig-macosenterprisewificonfiguration.md) -Objekt im Antworttext zurück.
