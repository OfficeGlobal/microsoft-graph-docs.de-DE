...
---
# <a name="create-macosvppappassignedlicense"></a>MacOsVppAppAssignedLicense erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das macOsVppAppAssignedLicense-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der macOsVppAppAssignedLicense erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [macOsVppAppAssignedLicense](../resources/intune-apps-macosvppappassignedlicense.md) -Objekt im Antworttext zurück.
