...
Wenn die Methode erfolgreich verläuft, werden der Antwortcode `200 OK` und das aktualisierte [RangeFill](../resources/rangefill.md)-Objekt im Antworttext zurückgegeben.
