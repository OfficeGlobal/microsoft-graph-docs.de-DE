...
---
# <a name="create-androidforworkgeneraldeviceconfiguration"></a>AndroidForWorkGeneralDeviceConfiguration erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das androidForWorkGeneralDeviceConfiguration-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der androidForWorkGeneralDeviceConfiguration erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [androidForWorkGeneralDeviceConfiguration](../resources/intune-deviceconfig-androidforworkgeneraldeviceconfiguration.md) -Objekt im Antworttext zurück.
