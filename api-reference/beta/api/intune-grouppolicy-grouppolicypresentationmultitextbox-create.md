...
---
# <a name="create-grouppolicypresentationmultitextbox"></a>Erstellen von groupPolicyPresentationMultiTextBox
...
Geben Sie im Textkörper Anforderung für das Objekt GroupPolicyPresentationMultiTextBox eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die GroupPolicyPresentationMultiTextBox erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `201 Created` Antwortcode und eines [GroupPolicyPresentationMultiTextBox](../resources/intune-grouppolicy-grouppolicypresentationmultitextbox.md) -Objekts in der Antworttext.
