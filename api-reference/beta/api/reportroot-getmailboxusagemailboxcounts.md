...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eines **[MailboxUsageMailboxCounts](../resources/mailboxusagemailboxcounts.md)** -Objekts in der Antworttext.
