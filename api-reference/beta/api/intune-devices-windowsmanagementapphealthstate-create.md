...
---
# <a name="create-windowsmanagementapphealthstate"></a>WindowsManagementAppHealthState erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das windowsManagementAppHealthState-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der windowsManagementAppHealthState erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [windowsManagementAppHealthState](../resources/intune-devices-windowsmanagementapphealthstate.md) -Objekt im Antworttext zurück.
