...
---
# <a name="add-educationcategories"></a>EducationCategories hinzufügen

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Fügen Sie diesem [educationAssignment](../resources/educationassignment.md)mindestens ein vorhandenes [EducationCategory](../resources/educationcategory.md) -Objekt hinzu.
...
Geben Sie im Anforderungstext die odata.id der vorhandenen [educationCategory](../resources/educationcategory.md) -Objekte an, die dieser Zuordnung hinzugefügt werden sollen.
...
```
Geben Sie im Anforderungstext die odata.id des vorhandenen [educationCategory](../resources/educationcategory.md) -Objekts an, das dieser Zuordnung hinzugefügt werden soll.
##### <a name="response"></a>Antwort
