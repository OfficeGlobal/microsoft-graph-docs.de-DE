...
---
# <a name="create-items"></a>Elemente erstellen
Erstellen eines Elements in Dynamics 365 Business Central für die Verwendung auf Rechnungen, Anführungszeichen usw.
...
Geben Sie im Anforderungstext eine JSON-Darstellung eines **Items** -Objekts an.

## <a name="response"></a>Antwort
Bei erfolgreicher Ausführung gibt diese Methode ```201 Created``` den Antwortcode und ein **Items** -Objekt im Antworttext zurück.
