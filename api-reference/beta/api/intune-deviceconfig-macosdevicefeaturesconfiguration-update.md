...
## <a name="http-request"></a><span data-ttu-id="d5bdc-118">HTTP-Anforderung</span><span class="sxs-lookup"><span data-stu-id="d5bdc-118">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
