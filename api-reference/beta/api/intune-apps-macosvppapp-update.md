...
Aktualisieren Sie die Eigenschaften eines [MacOsVppApp](../resources/intune-apps-macosvppapp.md) -Objekts.
...
Geben Sie im Textkörper Anforderung für das Objekt [MacOsVppApp](../resources/intune-apps-macosvppapp.md) eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die [MacOsVppApp](../resources/intune-apps-macosvppapp.md)erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eine aktualisierte [MacOsVppApp](../resources/intune-apps-macosvppapp.md) -Objekts in der Antworttext.
