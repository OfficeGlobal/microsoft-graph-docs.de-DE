...
---
# <a name="createdownloadurl-action"></a>createDownloadUrl-Aktion
...
Bei erfolgreicher Ausführung gibt die Aktion den `200 OK` Antwortcode und eine [appLogCollectionDownloadDetails](../resources/intune-devices-applogcollectiondownloaddetails.md) im Antworttext zurück.
