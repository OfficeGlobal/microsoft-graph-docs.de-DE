...
---
# <a name="searchexistingidentities-action"></a>searchExistingIdentities-Aktion
...
Bei erfolgreicher Ausführung gibt die Aktion den `200 OK` Antwortcode und eine [importedDeviceIdentity](../resources/intune-enrollment-importeddeviceidentity.md) -Auflistung im Antworttext zurück.
