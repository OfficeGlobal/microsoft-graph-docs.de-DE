...
---
# <a name="get-accounts"></a>Konten abrufen
Rufen Sie die Eigenschaften und Beziehungen eines Account-Objekts für Dynamics 365 Business Central ab.
...
Bei erfolgreicher Ausführung gibt diese Methode den `200 OK` Antwortcode und ein **Accounts** -Objekt im Antworttext zurück.

## <a name="example"></a>Beispiel

**Anforderung** Hier ist ein Beispiel für die Anforderung.
