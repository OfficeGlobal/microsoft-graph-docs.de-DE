...
---
# <a name="list-iosvppappassigneduserlicenses"></a>Liste iosVppAppAssignedUserLicenses
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eine Auflistung von Objekten im Antworttext [IosVppAppAssignedUserLicense](../resources/intune-apps-iosvppappassigneduserlicense.md) .
