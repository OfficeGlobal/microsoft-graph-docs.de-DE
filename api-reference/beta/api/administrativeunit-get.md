...
Rufen Sie die Eigenschaften und die Beziehungen eines [AdministrativeUnit](../resources/administrativeunit.md) -Objekts ab.

Da die Ressource **AdministrativeUnit** [Extensions](/graph/extensibility-overview)unterstützt, können Sie auch die `GET` Vorgang zum Abrufen von benutzerdefinierten Eigenschaften und Erweiterungsdaten in eine **AdministrativeUnit** -Instanz.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortobjekt Code und [AdministrativeUnit](../resources/administrativeunit.md) im Antworttext.
