...
---
# <a name="create-windowsdeliveryoptimizationconfiguration"></a>Erstellen von windowsDeliveryOptimizationConfiguration
...
Geben Sie im Textkörper Anforderung für das Objekt WindowsDeliveryOptimizationConfiguration eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die WindowsDeliveryOptimizationConfiguration erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `201 Created` Antwortcode und eines [WindowsDeliveryOptimizationConfiguration](../resources/intune-deviceconfig-windowsdeliveryoptimizationconfiguration.md) -Objekts in der Antworttext.
