...
---
# <a name="get-timeoffreason"></a>TimeOffReason abrufen

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Ruft die Eigenschaften und Beziehungen eines [TIMEOFFREASON](../resources/timeoffreason.md) -Objekts anhand der ID ab.
...
Bei erfolgreicher Ausführung gibt diese Methode den `200 OK` Antwortcode und ein [timeOffReason](../resources/timeoffreason.md) -Objekt im Antworttext zurück.
