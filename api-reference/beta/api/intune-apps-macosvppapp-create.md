...
---
# <a name="create-macosvppapp"></a>MacOsVppApp erstellen

> **Wichtig:** Microsoft Graph-APIs unter der/Beta-Version können geändert werden; die Produktion wird nicht unterstützt.

> **Hinweis:** Die Microsoft Graph-API für InTune benötigt eine [aktive INTUNE-Lizenz](https://go.microsoft.com/fwlink/?linkid=839381) für den Mandanten.

Erstellen eines neuen [macOsVppApp](../resources/intune-apps-macosvppapp.md) -Objekts.
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das macOsVppApp-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der macOsVppApp erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [macOsVppApp](../resources/intune-apps-macosvppapp.md) -Objekt im Antworttext zurück.
