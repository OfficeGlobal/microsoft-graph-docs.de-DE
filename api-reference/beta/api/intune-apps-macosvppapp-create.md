...
---
# <a name="create-macosvppapp"></a>Erstellen von macOsVppApp
...
Geben Sie im Textkörper Anforderung für das Objekt MacOsVppApp eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die MacOsVppApp erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `201 Created` Antwortcode und eines [MacOsVppApp](../resources/intune-apps-macosvppapp.md) -Objekts in der Antworttext.
