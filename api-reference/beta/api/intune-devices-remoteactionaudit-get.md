...
Bei erfolgreicher Ausführung gibt die Methode den `200 OK` Antwortcode und das [Remote Action Audit](../resources/intune-devices-remoteactionaudit.md) -Objekt im Antworttext zurück.
