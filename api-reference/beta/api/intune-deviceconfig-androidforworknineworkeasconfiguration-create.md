...
---
# <a name="create-androidforworknineworkeasconfiguration"></a>AndroidForWorkNineWorkEasConfiguration erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das androidForWorkNineWorkEasConfiguration-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der androidForWorkNineWorkEasConfiguration erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [androidForWorkNineWorkEasConfiguration](../resources/intune-deviceconfig-androidforworknineworkeasconfiguration.md) -Objekt im Antworttext zurück.
