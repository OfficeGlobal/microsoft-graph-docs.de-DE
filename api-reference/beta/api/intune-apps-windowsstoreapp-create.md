...
---
# <a name="create-windowsstoreapp"></a>WindowsStoreApp erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das windowsStoreApp-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der windowsStoreApp erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) -Objekt im Antworttext zurück.
