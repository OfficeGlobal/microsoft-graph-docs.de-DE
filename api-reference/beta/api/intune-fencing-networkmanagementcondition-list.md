...
---
# <a name="list-networkmanagementconditions"></a>Liste networkManagementConditions
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eine Auflistung von Objekten im Antworttext [NetworkManagementCondition](../resources/intune-fencing-networkmanagementcondition.md) .
