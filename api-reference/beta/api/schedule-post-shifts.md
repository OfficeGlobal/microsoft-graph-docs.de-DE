...
---
# <a name="create-shift"></a>Schicht erstellen

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Erstellen Sie eine neue [Schicht](../resources/shift.md) Instanz in einem [Zeitplan](../resources/schedule.md).
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [Shift](../resources/shift.md) -Objekt im Antworttext zurück.
