...
---
# <a name="list-privilegedroleassignments"></a>Liste privilegedRoleAssignments

> **Wichtig:** Die APIs der /Beta-Version in Microsoft Graph befinden sich in der Vorschau und können Änderungen unterliegen. Die Verwendung dieser APIs in Produktionsanwendungen wird nicht unterstützt.

Abrufen einer Liste von [PrivilegedRoleAssignment](../resources/privilegedroleassignment.md) -Objekten, die alle rollenzuweisungen für die Organisation entsprechen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und Auflistung von Objekten im Antworttext [PrivilegedRoleAssignment](../resources/privilegedroleassignment.md) .
...
### <a name="get-all-role-assignments"></a>Alle rollenzuweisungen abgerufen
##### <a name="request"></a>Anforderung
Das folgende Beispiel zeigt eine Anforderung an alle rollenzuweisungen abgerufen:
<!-- {
  "blockType": "request",
...
```
### <a name="get-active-role-assignments"></a>Abrufen der aktiven rollenzuweisungen
##### <a name="request"></a>Anforderung 
Das folgende Beispiel zeigt eine Anforderung zum aktiven rollenzuweisungen Abfrage:
<!-- {
  "blockType": "request",
  "name": "get_privilegedroleassignments"
}-->
...
```
### <a name="get-permanent-role-assignments"></a>Abrufen der permanente rollenzuweisungen
##### <a name="request"></a>Anforderung 
Das folgende Beispiel zeigt eine Anforderung an die Abfrage permanente rollenzuweisungen, wobei ``expirationDateTime`` Wert ist ``null``:
<!-- {
  "blockType": "request",
  "name": "get_privilegedroleassignments"
}-->
...
```
### <a name="get-eligible-role-assignments"></a>Abrufen von zu auswählbaren rollenzuweisungen
##### <a name="request"></a>Anforderung 
Das folgende Beispiel zeigt eine Anforderung an die Abfrage zu auswählbaren rollenzuweisungen, einschließlich der aktiven und inaktiven:
<!-- {
  "blockType": "request",
  "name": "get_privilegedroleassignments"
}-->
