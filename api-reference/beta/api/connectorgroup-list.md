...
---
# <a name="list-connectorgroups"></a>Liste connectorGroups

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Abrufen einer Liste von Connectorgroup-Objekten.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und Auflistung von Objekten im Antworttext [ConnectorGroup](../resources/connectorgroup.md) .
