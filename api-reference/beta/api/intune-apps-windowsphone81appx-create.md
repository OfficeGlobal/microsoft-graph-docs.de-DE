...
---
# <a name="create-windowsphone81appx"></a>WindowsPhone81AppX erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das windowsPhone81AppX-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der windowsPhone81AppX erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) -Objekt im Antworttext zurück.
