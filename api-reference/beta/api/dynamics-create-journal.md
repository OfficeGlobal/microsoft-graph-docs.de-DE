...
---
# <a name="create-journals"></a>Erstellen von Journalen
Erstellt ein Journal in Dynamics 365 Business Central. 
...
Geben Sie im Anforderungstext eine JSON-Darstellung eines **Journals** -Objekts an.

## <a name="response"></a>Antwort
Bei erfolgreicher Ausführung gibt diese Methode ```201 Created``` den Antwortcode und **** ein Journals-Objekt im Antworttext zurück.
