...
Aktualisieren der Eigenschaften eines [iosWiFiConfiguration](../resources/intune-deviceconfig-ioswificonfiguration.md) -Objekts.
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das [iosWiFiConfiguration](../resources/intune-deviceconfig-ioswificonfiguration.md) -Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der [iosWiFiConfiguration](../resources/intune-deviceconfig-ioswificonfiguration.md)erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `200 OK` Antwortcode und ein aktualisiertes [iosWiFiConfiguration](../resources/intune-deviceconfig-ioswificonfiguration.md) -Objekt im Antworttext zurück.
