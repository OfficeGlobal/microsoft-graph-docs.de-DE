...
---
# <a name="list-governanceroleassignments"></a>Liste governanceRoleAssignments

> **Wichtig:** Die APIs der /Beta-Version in Microsoft Graph befinden sich in der Vorschau und können Änderungen unterliegen. Die Verwendung dieser APIs in Produktionsanwendungen wird nicht unterstützt.

Eine Auflistung der [GovernanceRoleAssignments](../resources/governanceroleassignment.md)abzurufen.
...
Eine Auflistung von [GovernanceRoleAssignments](../resources/governanceroleassignment.md) für eine Ressource aufgelistet.
...
```
Eine Auflistung von [GovernanceRoleAssignments](../resources/governanceroleassignment.md) Meine aufgelistet.
```http
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und eine Auflistung von Objekten im Antworttext [GovernanceRoleAssignment](../resources/governanceroleassignment.md) .
## <a name="example"></a>Beispiel

In diesem Beispiel wird gezeigt, wie meine rollenzuweisungen für das Abonnement Wingtip Toys - "Bemerkungen" abgerufen.
<!-- {
  "blockType": "request",
