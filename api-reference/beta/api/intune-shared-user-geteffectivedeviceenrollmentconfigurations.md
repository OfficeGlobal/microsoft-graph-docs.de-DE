...
Wenn erfolgreich, diese Funktion gibt eine `200 OK` Antwortcode und eine [DeviceEnrollmentConfiguration](../resources/intune-onboarding-deviceenrollmentconfiguration.md) -Auflistung im Antworttext.
