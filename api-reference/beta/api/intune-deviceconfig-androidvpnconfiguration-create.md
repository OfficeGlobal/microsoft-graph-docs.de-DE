...
---
# <a name="create-androidvpnconfiguration"></a>AndroidVpnConfiguration erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das androidVpnConfiguration-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der androidVpnConfiguration erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [androidVpnConfiguration](../resources/intune-deviceconfig-androidvpnconfiguration.md) -Objekt im Antworttext zurück.
