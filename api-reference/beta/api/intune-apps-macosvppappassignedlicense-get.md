...
Bei erfolgreicher Ausführung gibt die Methode den `200 OK` Antwortcode und das [macOsVppAppAssignedLicense](../resources/intune-apps-macosvppappassignedlicense.md) -Objekt im Antworttext zurück.
