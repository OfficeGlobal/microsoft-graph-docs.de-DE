...
---
# <a name="create-grouppolicypresentationlistbox"></a>Erstellen von groupPolicyPresentationListBox
...
Geben Sie im Textkörper Anforderung für das Objekt GroupPolicyPresentationListBox eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die GroupPolicyPresentationListBox erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `201 Created` Antwortcode und eines [GroupPolicyPresentationListBox](../resources/intune-grouppolicy-grouppolicypresentationlistbox.md) -Objekts in der Antworttext.
