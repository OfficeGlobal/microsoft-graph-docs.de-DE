...
---
# <a name="list-customers"></a>Liste von Kunden

 > **Wichtig:** Die APIs der /Beta-Version in Microsoft Graph befinden sich in der Vorschau und können Änderungen unterliegen. Die Verwendung dieser APIs in Produktionsanwendungen wird nicht unterstützt.
 
Abrufen einer Liste von [BookingCustomer](../resources/bookingcustomer.md) -Objekten.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und Auflistung von Objekten im Antworttext [BookingCustomer](../resources/bookingcustomer.md) .
