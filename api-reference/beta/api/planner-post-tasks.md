...
---
# <a name="create-plannertask"></a>plannerTask erstellen

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Verwenden Sie diese API zum Erstellen eines neuen **plannerTask**-Objekts.
...
```
Geben Sie im Anforderungstext eine JSON-Darstellung des [plannerTask](../resources/plannertask.md)-Objekts an.
##### <a name="response"></a>Antwort
