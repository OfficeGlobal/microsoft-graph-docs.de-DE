...
Rufen Sie die Liste der Gruppen und Directory Rollen, denen dieser Dienst principal ein Mitglied ist.  Diese Überprüfung ist transitiv.
...
|:---------------|:--------|:----------|
|securityEnabledOnly|Boolescher Wert||
