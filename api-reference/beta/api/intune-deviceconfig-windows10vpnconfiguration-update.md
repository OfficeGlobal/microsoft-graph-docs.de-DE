...
---
# <a name="update-windows10vpnconfiguration"></a>Windows10VpnConfiguration aktualisieren

> **Wichtig:** Microsoft Graph-APIs unter der/Beta-Version können geändert werden; die Produktion wird nicht unterstützt.

> **Hinweis:** Die Microsoft Graph-API für InTune benötigt eine [aktive INTUNE-Lizenz](https://go.microsoft.com/fwlink/?linkid=839381) für den Mandanten.

Aktualisieren der Eigenschaften eines [windows10VpnConfiguration](../resources/intune-deviceconfig-windows10vpnconfiguration.md) -Objekts.
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das [windows10VpnConfiguration](../resources/intune-deviceconfig-windows10vpnconfiguration.md) -Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der [windows10VpnConfiguration](../resources/intune-deviceconfig-windows10vpnconfiguration.md)erforderlich sind.
...
|singleSignOnIssuerHash|String|Single Sign-on-Aussteller-Hash.|
...
|trafficRules|[vpnTrafficRule](../resources/intune-deviceconfig-vpntrafficrule.md) -Sammlung|Datenverkehrs Regeln. Diese Collection darf maximal 1.000 Elemente enthalten.|
|Routen|[vpnRoute](../resources/intune-deviceconfig-vpnroute.md) -Sammlung|Routen (optional für Drittanbieter). Diese Collection darf maximal 1.000 Elemente enthalten.|
|dnsRules|[vpnDnsRule](../resources/intune-deviceconfig-vpndnsrule.md) -Sammlung|DNS-Regeln. Diese Collection darf maximal 1.000 Elemente enthalten.|
|trustedNetworkDomains|String collection|Vertrauenswürdige Netzwerkdomänen|



## <a name="response"></a>Antwort
Bei erfolgreicher Ausführung gibt diese Methode den `200 OK` Antwortcode und ein aktualisiertes [windows10VpnConfiguration](../resources/intune-deviceconfig-windows10vpnconfiguration.md) -Objekt im Antworttext zurück.
