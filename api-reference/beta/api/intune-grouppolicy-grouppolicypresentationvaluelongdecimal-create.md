...
---
# <a name="create-grouppolicypresentationvaluelongdecimal"></a>Erstellen von groupPolicyPresentationValueLongDecimal
...
Geben Sie im Textkörper Anforderung für das Objekt GroupPolicyPresentationValueLongDecimal eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die GroupPolicyPresentationValueLongDecimal erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `201 Created` Antwortcode und eines [GroupPolicyPresentationValueLongDecimal](../resources/intune-grouppolicy-grouppolicypresentationvaluelongdecimal.md) -Objekts in der Antworttext.
