...
|:---|:---|:---|
|officeConfigurationPolicyIds|Collection von Objekten des Typs „String“|Liste der Office-Konfiguration Richtlinie-ids|
|officeConfigurationPriorities|Int32-Auflistung|Liste der Prioritäten für Office-Konfiguration|



## <a name="response"></a>Antwort
Bei erfolgreicher Ausführung gibt die Aktion den Antwortcode `200 OK` zurück.
