...
---
# <a name="create-androidforworkenterprisewificonfiguration"></a>AndroidForWorkEnterpriseWiFiConfiguration erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das androidForWorkEnterpriseWiFiConfiguration-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der androidForWorkEnterpriseWiFiConfiguration erforderlich sind.
...
|networkName|String|Netzwerk Name geerbt von [androidForWorkWiFiConfiguration](../resources/intune-deviceconfig-androidforworkwificonfiguration.md)|
|SSID|String|Dies ist der Name des WLAN-Netzwerks, das auf alle Geräte übertragen wird. Geerbt von [androidForWorkWiFiConfiguration](../resources/intune-deviceconfig-androidforworkwificonfiguration.md)|
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [androidForWorkEnterpriseWiFiConfiguration](../resources/intune-deviceconfig-androidforworkenterprisewificonfiguration.md) -Objekt im Antworttext zurück.
