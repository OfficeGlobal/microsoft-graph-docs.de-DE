...
---
# <a name="create-androidimportedpfxcertificateprofile"></a>AndroidImportedPFXCertificateProfile erstellen
...
Geben Sie im Anforderungstext eine JSON-Darstellung für das androidImportedPFXCertificateProfile-Objekt an.

In der folgenden Tabelle sind die Eigenschaften dargestellt, die zum Erstellen der androidImportedPFXCertificateProfile erforderlich sind.
...
Bei erfolgreicher Ausführung gibt diese Methode den `201 Created` Antwortcode und ein [androidImportedPFXCertificateProfile](../resources/intune-deviceconfig-androidimportedpfxcertificateprofile.md) -Objekt im Antworttext zurück.
