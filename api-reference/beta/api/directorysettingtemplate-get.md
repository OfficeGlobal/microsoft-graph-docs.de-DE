...
> **Hinweis**: die Version /beta diese API ist nur auf Gruppen angewendet wird. Die /v1.0 Version dieser API wurde zum *Abrufen von GroupSettingTemplate*umbenannt.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortobjekt Code und [DirectorySettingTemplate](../resources/directorysettingtemplate.md) im Antworttext.
