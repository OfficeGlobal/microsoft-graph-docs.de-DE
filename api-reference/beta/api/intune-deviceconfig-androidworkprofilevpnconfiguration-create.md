...
---
# <a name="create-androidworkprofilevpnconfiguration"></a>Erstellen von androidWorkProfileVpnConfiguration
...
Geben Sie im Textkörper Anforderung für das Objekt AndroidWorkProfileVpnConfiguration eine JSON-Darstellung.

In der folgenden Tabelle werden die Eigenschaften gezeigt, die erforderlich sind, wenn Sie die AndroidWorkProfileVpnConfiguration erstellen.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `201 Created` Antwortcode und eines [AndroidWorkProfileVpnConfiguration](../resources/intune-deviceconfig-androidworkprofilevpnconfiguration.md) -Objekts in der Antworttext.
