...
|targetedAppManagementLevels|[appManagementLevel](../resources/intune-mam-appmanagementlevel.md)|Die vorgesehene app Management Ebenen für diese Richtlinie. Mögliche Werte: `unspecified`, `unmanaged`, `mdm`, `androidEnterprise`.|
