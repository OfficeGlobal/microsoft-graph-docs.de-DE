...
Die **Event Message** -Entität ist von [Message](message.md)abgeleitet, und [eventMessageRequest](eventmessagerequest.md) wird von **Event Message** abgeleitet und stellt eine Besprechungsanfrage dar. Die **meetingMessageType**-Eigenschaft gibt den Typ der Ereignisnachricht an.
...
|isAllDay |Boolean|Gibt an, ob das Ereignis den ganzen Tag dauert. Zum Anpassen dieser Eigenschaft müssen auch **** die Eigenschaften StartDateTime und Enddatum des Ereignisses angepasst werden. ****|
...
|location|[location](location.md)|Der Ort der angeforderten Besprechung.|
...
|:---------------|:--------|:----------|
|attachments|[attachment](attachment.md) collection|Die Auflistung von [](fileattachment.md)FileAttachment-, [ItemAttachment](itemattachment.md)-und [referenceAttachment](referenceattachment.md) -Anlagen für die Nachricht. Schreibgeschützt. Nullwerte zulassend.|
...
|[Offene Erweiterung abrufen](../api/opentypeextension-get.md) |[openTypeExtension](opentypeextension.md)-Sammlung| Abrufen einer geöffneten Erweiterung, die anhand des Namens identifiziert wird.|
