...
Enthält Eigenschaften und geerbten Eigenschaften für Windows Phone XAP-Line Of Business apps.
...
|:---|:---|:---|
|[Liste windowsPhoneXAPs](../api/intune-apps-windowsphonexap-list.md)|[WindowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) -Auflistung|Listeneigenschaften und Beziehungen der [WindowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) -Objekte.|
|[Abrufen von windowsPhoneXAP](../api/intune-apps-windowsphonexap-get.md)|[windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)|Lesen Sie Eigenschaften und Beziehungen des [WindowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) -Objekts.|
|[Erstellen von windowsPhoneXAP](../api/intune-apps-windowsphonexap-create.md)|[windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)|Erstellen eines neuen [WindowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) -Objekts.|
|[WindowsPhoneXAP löschen](../api/intune-apps-windowsphonexap-delete.md)|Keines|Löscht eine [WindowsPhoneXAP](../resources/intune-apps-windowsphonexap.md).|
|[WindowsPhoneXAP aktualisieren](../api/intune-apps-windowsphonexap-update.md)|[windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)|Aktualisieren Sie die Eigenschaften eines [WindowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) -Objekts.|
...
|productIdentifier|String|Die Produkt-ID.|
