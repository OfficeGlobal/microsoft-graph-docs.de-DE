...
|[WindowsWifiConfiguration löschen](../api/intune-deviceconfig-windowswificonfiguration-delete.md)|Keines|Löscht eine [WindowsWifiConfiguration](../resources/intune-deviceconfig-windowswificonfiguration.md).|
