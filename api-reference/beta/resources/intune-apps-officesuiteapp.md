...
|[OfficeSuiteApp löschen](../api/intune-apps-officesuiteapp-delete.md)|Keines|Löscht eine [OfficeSuiteApp](../resources/intune-apps-officesuiteapp.md).|
