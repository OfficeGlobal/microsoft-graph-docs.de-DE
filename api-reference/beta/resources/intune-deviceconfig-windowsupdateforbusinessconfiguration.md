...
|[extendFeatureUpdatesPause-Aktion](../api/intune-deviceconfig-windowsupdateforbusinessconfiguration-extendfeatureupdatespause.md)|Keine|Extend-Feature-Updates halten für einen Windows Update for Business-Ring an.|
|[extendQualityUpdatesPause-Aktion](../api/intune-deviceconfig-windowsupdateforbusinessconfiguration-extendqualityupdatespause.md)|Keine|Extend Quality Updates Pause für ein Windows Update for Business-Ring.|
