...
|:---|:---|:---|
|[webApps auflisten](../api/intune-apps-webapp-list.md)|[webApp](../resources/intune-apps-webapp.md)-Sammlung|Listet die Eigenschaften und Beziehungen von Objekten des Typs [webApp](../resources/intune-apps-webapp.md) auf.|
|[webApp abrufen](../api/intune-apps-webapp-get.md)|[webApp](../resources/intune-apps-webapp.md)|Lesen von Eigenschaften und Beziehungen des [webApp](../resources/intune-apps-webapp.md)-Objekts.|
|[webApp erstellen](../api/intune-apps-webapp-create.md)|[webApp](../resources/intune-apps-webapp.md)|Erstellen eines neuen [webApp](../resources/intune-apps-webapp.md)-Objekts.|
|[webApp löschen](../api/intune-apps-webapp-delete.md)|Keine|Löscht eine [webApp](../resources/intune-apps-webapp.md).|
|[webApp aktualisieren](../api/intune-apps-webapp-update.md)|[webApp](../resources/intune-apps-webapp.md)|Aktualisiert die Eigenschaften eines [webApp](../resources/intune-apps-webapp.md)-Objekts.|
