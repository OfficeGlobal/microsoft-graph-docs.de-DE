...
|[WindowsKioskConfiguration löschen](../api/intune-deviceconfig-windowskioskconfiguration-delete.md)|Keines|Löscht eine [WindowsKioskConfiguration](../resources/intune-deviceconfig-windowskioskconfiguration.md).|
