...
Android-Gerät Besitzer mögliche Werte für Status des Geräts app Auto Richtlinie aktualisiert werden.
## <a name="members"></a>Elemente
|Element|Wert|Beschreibung|
|:---|:---|:---|
|nicht konfiguriert|0|Nicht konfiguriert. Dieser Wert wird ignoriert.|
|UserChoice um|1|Der Benutzer kann die automatische Updates steuern.|
|nie|2|Apps werden nie mit automatisch aktualisiert.|
|wiFiOnly|3|Apps werden automatisch aktualisiert über Wi-Fi nur.|
|immer|4|Apps werden können Sie jederzeit automatisch aktualisiert. Daten können anfallen.|
