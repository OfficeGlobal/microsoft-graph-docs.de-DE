...
## <a name="group-based-licensing"></a>Arbeitsgruppen-Lizenzierung 

Arbeitsgruppen-Lizenzierung Funktion kann verwendet werden, eine Azure Active Directory-Gruppe einen oder mehrere Lizenzen zuweisen. Azure AD wird sichergestellt, dass die Lizenzen an alle Mitglieder der Gruppe zugewiesen sind. Alle neuen Elemente, die die Gruppe "Leistungsprotokollbenutzer" werden die entsprechenden Lizenzen zugewiesen. Wenn sie die Gruppe verlassen, werden diese Lizenzen entfernt. Das Feature kann nur verwendet werden, mit der Sicherheitsgruppen und Office 365-Gruppen, bei denen SecurityEnabled haben = TRUE. Erfahren Sie mehr über Arbeitsgruppen-Lizenzierung finden [hier](https://docs.microsoft.com/azure/active-directory/fundamentals/active-directory-licensing-whatis-azure-portal).
