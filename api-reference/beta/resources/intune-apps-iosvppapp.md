...
|[RevokeAllLicenses Aktion](../api/intune-apps-iosvppapp-revokealllicenses.md)|Keines|REVOKE alle zugewiesenen iOS lizenziert VPP für die angegebene app.|
|[RevokeUserLicense Aktion](../api/intune-apps-iosvppapp-revokeuserlicense.md)|Keines|REVOKE zugewiesen iOS VPP-Benutzerlizenz für die app zu reparieren.|
|[RevokeDeviceLicense Aktion](../api/intune-apps-iosvppapp-revokedevicelicense.md)|Keines|REVOKE zugewiesen iOS VPP Gerätenlizenz für app zu reparieren.|
...
|vppTokenId|String|Bezeichner des Tokens VPP diese app zugeordnet.|
