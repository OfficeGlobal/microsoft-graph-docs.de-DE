...
| companyName                  | Zeichenfolge                                                    | Name des Unternehmens, die diesen Kontakt Organisationseinheit angehören.                                                                                                                                                                                                                                                                                                                 |
| department                   | Zeichenfolge                                                     | Der Name für die Abteilung, in der der Kontakt arbeitet.                                                                                                                                                                                                                                                                                                                                |
| displayName                  | Zeichenfolge                                                     | Der Anzeigename für diesen Kontakt Organisationseinheit.                                                                                                                                                                                                                                                                                                                                   |
| givenName                    | Zeichenfolge                                                     | Vorname für diesen Kontakt Organisationseinheit.                                                                                                                                                                                                                                                                                                                                     |
| id                           | Zeichenfolge                                                     | Eindeutiger Bezeichner für diesen Kontakt Organisationseinheit.                                                                                                                                                                                                                                                                                                                             |
...
| jobTitle                     | Zeichenfolge                                                     | Position für diesen Kontakt Organisationseinheit.                                                                                                                                                                                                                                                                                                                                      |
|mail|Zeichenfolge| Die SMTP-Adresse für den Kontakt, z. B. "jeff@contoso.onmicrosoft.com". |
...
| surname                      | Zeichenfolge                                                     | Nachname für diesen Kontakt Organisationseinheit.                          |
