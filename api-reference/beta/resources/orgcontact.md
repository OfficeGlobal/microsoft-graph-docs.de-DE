...
|:---------------|:--------|:----------|
|[Abrufen von orgContact](../api/orgcontact-get.md) | [orgContact](../resources/orgcontact.md) |Lesen Sie Eigenschaften und Beziehungen des OrgContact-Objekts.|
|[Get-manager](../api/orgcontact-get-manager.md) |[directoryObject](../resources/directoryobject.md)| Rufen Sie den Manager des Kontakts.|
|[List directReports](../api/orgcontact-list-directreports.md) |[directoryObject](../resources/directoryobject.md) collection| Der Kontakt direkt unterstellte aufgelistet.|
|[memberOf auflisten](../api/orgcontact-list-memberof.md) |[directoryObject](../resources/directoryobject.md)-Sammlung| Get-Auflistung ein Mitglied-Objekts.|
|[Löschen](../api/orgcontact-delete.md) | Keine |OrgContact-Objekt zu löschen. |
...
|:---------------|:--------|:----------|
| addresses                    | [PhysicalOfficeAddress](../resources/physicalofficeaddress.md) -Auflistung           | Postanschriften für diesen Kontakt Organisationseinheit. Jetzt kann ein Kontakt nur eine physische Adresse haben. |
...
| onPremisesProvisioningErrors | [onPremisesProvisioningError](../resources/onpremisesprovisioningerror.md)-Sammlung       | Liste der Fehler für diesen Kontakt Organisationseinheit provisioning Synchronisierung.                                                                                                                                                                                                                                                                                                |
...
| phones                       | [phone](../resources/phone.md)-Sammlung                  | Liste der Telefone für diesen Kontakt Organisationseinheit. Telefon-Typen können Mobile, Geschäfts- und geschäftlich Fax sein. Nur eine der einzelnen Typen kann jemals in der Auflistung vorhanden sein.                                                                                                                       |
...
|:---------------|:--------|:----------|
|directReports|[directoryObject](../resources/directoryobject.md) collection| Mitarbeiter des Kontakts. (Die Benutzer und Kontakte, die die Manager-Eigenschaft, die auf diesen Kontakt festgelegt werden.)  Schreibgeschützt. Nullwerte zulassend.|
|manager|[directoryObject](../resources/directoryobject.md)| Der Benutzer oder Kontakt, der Vorgesetzte des Kontakts ist. Schreibgeschützt.|
|memberOf|[directoryObject](../resources/directoryobject.md)-Sammlung| Gruppen, denen diesen Kontakt ein Mitglied ist. Schreibgeschützt. Lässt Nullwerte zu.|
