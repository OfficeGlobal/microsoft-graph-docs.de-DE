...
---
# <a name="macoscertificateprofilebase-resource-type"></a>macOSCertificateProfileBase-Ressourcentyp

> **Wichtig:** Microsoft Graph-APIs unter der/Beta-Version können geändert werden; die Produktion wird nicht unterstützt.

> **Hinweis:** Die Microsoft Graph-API für InTune benötigt eine [aktive INTUNE-Lizenz](https://go.microsoft.com/fwlink/?linkid=839381) für den Mandanten.

Mac OS-Zertifikat Profil.
...
|:---|:---|:---|
|[MacOSCertificateProfileBases aufListen](../api/intune-deviceconfig-macoscertificateprofilebase-list.md)|[macOSCertificateProfileBase](../resources/intune-deviceconfig-macoscertificateprofilebase.md) -Sammlung|AufListen von Eigenschaften und Beziehungen der [macOSCertificateProfileBase](../resources/intune-deviceconfig-macoscertificateprofilebase.md) -Objekte.|
|[MacOSCertificateProfileBase abrufen](../api/intune-deviceconfig-macoscertificateprofilebase-get.md)|[macOSCertificateProfileBase](../resources/intune-deviceconfig-macoscertificateprofilebase.md)|Lesen von Eigenschaften und Beziehungen des [macOSCertificateProfileBase](../resources/intune-deviceconfig-macoscertificateprofilebase.md) -Objekts.|
