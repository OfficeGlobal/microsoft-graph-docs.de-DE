...
|:---------------|:--------|:----------|
|availabilityView |String |Stellt eine zusammengeführte Ansicht der Verfügbarkeit aller Elemente in `scheduleItems`dar. Die Ansicht besteht aus Zeitschlitzen. Die Verfügbarkeit in jedem Zeitschlitz wird mit `0`: = Free `1`, = zaghaft `2`, = busy `3`, = Abwesenheit, `4`= arbeiten an einem anderen Ort angezeigt.|
...
|scheduleId |String |Eine SMTP-Adresse des Benutzers, der Verteilerliste oder der Ressource, die eine Instanz von **scheduleInformation**identifiziert. |
