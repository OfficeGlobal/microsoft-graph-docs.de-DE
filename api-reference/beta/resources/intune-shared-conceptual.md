...
- [Registrierung Gerätetyp](intune-shared-deviceenrollmenttype.md)
- [deviceManagement](intune-shared-devicemanagement.md)
- [Gerätetyp-Plattform](intune-shared-deviceplatformtype.md)
- [Gerätetyp](intune-shared-devicetype.md)
- [Aktivierung von Steuerelementen](intune-shared-enablement.md)
...
- [Resultierende app-Status](intune-shared-resultantappstate.md)
- [RGB-Farbe](intune-shared-rgbcolor.md)
- [Führen Sie als Kontotyp](intune-shared-runasaccounttype.md)
