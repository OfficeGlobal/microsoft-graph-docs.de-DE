...
|[IosVpnConfiguration löschen](../api/intune-deviceconfig-iosvpnconfiguration-delete.md)|Keines|Löscht eine [IosVpnConfiguration](../resources/intune-deviceconfig-iosvpnconfiguration.md).|
