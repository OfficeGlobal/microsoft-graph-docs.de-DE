...
|[Create Message](../api/user-post-messages.md) |[Nachricht](message.md)| Erstellt eine Nachricht durch Veröffentlichung in der Nachrichtensammlung.|
...
|[List calendarView](../api/user-list-calendarview.md) |[Event](event.md)-Sammlung| Ruft eine Ereignisobjektsammlung ab.|
|[Auflisten von Kontakten](../api/user-list-contacts.md) |[Contact](contact.md) collection| Ruft eine Kontaktsammlung aus dem Standardkontaktordner des angemeldeten Benutzers ab.|
...
|[List memberOf](../api/user-list-memberof.md) |[directoryObject](directoryobject.md)-Sammlung| Ruft die Gruppen, Verzeichnisrollen und administrativen Einheiten, bei denen dieser Benutzer direktes Mitglied ist, aus der memberOf-Navigationseigenschaft ab.|
|[Transitive memberOf auflisten](../api/user-list-transitivememberof.md) |[directoryObject](directoryobject.md)-Sammlung| Listet die Gruppen, Verzeichnisrollen und administrativen Einheiten auf, bei denen der Benutzer Mitglied ist. Dieser Vorgang ist transitiv und schließt die Gruppen ein, in denen der Benutzer ein geschachteltes Mitglied ist. |
|[joinedTeams auflisten](../api/user-list-joinedteams.md) |[groups](group.md)-Sammlung| Ruft die Microsoft Teams aus der joinedTeams-Navigationseigenschaft auf, bei denen dieser Benutzer direktes Mitglied ist.|
...
|[plannerTasks auflisten](../api/planneruser-list-tasks.md) |[plannerTask](plannertask.md)-Sammlung| Gibt die dem Benutzer zugewiesenen plannerTasks zurück.|
|[registeredDevices auflisten](../api/user-list-registereddevices.md) |[directoryObject](directoryobject.md)-Sammlung| Ruft die Geräte, die für den Benutzer registriert sind, aus der registeredDevices-Navigationseigenschaft ab.|
|[Mitgliedschaften mit Bereichsrolle auflisten](../api/user-list-scopedrolememberof.md) |[scopedRoleMembership](scopedrolemembership.md)-Sammlung| Ruft die Mitgliedschaften mit Bereichsrolle in administrativen Einheiten für diesen Benutzer ab.|
|[createdObjects auflisten](../api/user-list-createdobjects.md) |[directoryObject](directoryobject.md) collection| Ruft die Verzeichnisobjekte, die von dem Benutzer erstellt wurden, aus der createdObjects-Navigationseigenschaft ab.|
|[agreementAcceptances auflisten](../api/user-list-agreementacceptances.md) | [agreementAcceptance](agreementacceptance.md)-Sammlung | Erhalten Sie eine List der Annahme der Nutzungsbedingungen-Zustände der Benutzer.|
...
|[findMeetingTimes](../api/user-findmeetingtimes.md)|[meetingTimeSuggestionsResult](meetingtimesuggestionsresult.md)|Sucht Zeiten und Orte für Besprechungen basierend auf der Teilnehmerverfügbarkeit, dem Standort oder zeitlichen Einschränkungen.|
...
|[getMemberObjects](../api/user-getmemberobjects.md)|Zeichenfolgenauflistung| Gibt alle Gruppen, Verzeichnisrollen und administrativen Einheiten zurück, bei denen der Benutzer Mitglied ist. Die Überprüfung ist transitiv. |
|[invalidateAllRefreshTokens](../api/user-invalidateallrefreshtokens.md)| Keine |Macht alle Aktualisierungs- und Sitzungstoken ungültig, die für Anwendungen ausgegeben werden, indem die Benutzereigenschaft **refreshTokensValidFromDateTime** auf das aktuelle Datum und die aktuelle Zeit eingestellt werden. Dadurch wird der Benutzer gezwungen, sich erneut bei diesen Anwendungen anzumelden.|
...
|[Outlook-IDs übersetzen](../api/user-translateexchangeids.md) |[convertIdResult-Ressourcentyp](convertidresult.md)-Sammlung| Übersetzt IDs von Outlook-bezogenen Ressourcen zwischen den Formaten.|
...
|externalUserState|String|Bei einem externen Benutzer, der über die [Einladungs-API](../api/invitation-post.md) zum Mandanten eingeladen wurde, stellt diese Eigenschaft den Einladungsstatus des eingeladenen Benutzers dar. Für eingeladene Benutzer kann der Status "PendingAcceptance" oder "Accepted" sein, und für alle anderen Benutzer kann er `null` sein. Unterstützt $filter mit den unterstützten Werten. Zum Beispiel: `$filter=externalUserState eq 'PendingAcceptance'`.|
...
|proxyAddresses|String collection|Beispiel: `["SMTP: bob@contoso.com", "smtp: bob@sales.contoso.com"]` Der **any**-Operator ist für Filterausdrücke für mehrwertige Eigenschaften erforderlich. Schreibgeschützt, keine Nullwerte zulassend. Unterstützt $filter.          |
|refreshTokensValidFromDateTime|DateTimeOffset| Alle Aktualisierungstoken oder Sitzungstoken (Sitzungscookies), die vor diesem Zeitpunkt ausgegeben wurden, sind ungültig, und Anwendungen geben eine Fehlermeldung aus, wenn ein ungültiges Aktualisierungs- oder Sitzungstoken verwendet wird, um ein delegiertes Zugriffstoken (z. B. für den Zugriff auf APIs wie Microsoft Graph) anzufordern.  In diesem Fall muss die Anwendung ein neues Aktualisierungstoken anfordern, indem eine Anforderung an den autorisierten Endpunkt gestellt wird. Schreibgeschützt. Verwenden Sie [invalidateAllRefreshTokens](../api/user-invalidateallrefreshtokens.md) zum Zurücksetzen.|
...
|:---------------|:--------|:----------|
|agreementAcceptances|[agreementAcceptance](agreementacceptance.md)-Sammlung| Annahmestatus der Nutzungsbedingungen Schreibgeschützt. Lässt Nullwerte zu.|
|calendar|[Kalender](calendar.md)|Primärer Kalender des Benutzers. Schreibgeschützt.|
|calendarGroups|[calendarGroup](calendargroup.md)-Sammlung|Die Kalendergruppen des Benutzers. Schreibgeschützt. Nullwerte zulassend.|
|calendarView|[event](event.md)-Sammlung|Die Kalenderansicht für den Kalender. Schreibgeschützt. Nullwerte zulassend.|
|calendars|[calender](calendar.md)-Sammlung|Die Kalender des Benutzers. Schreibgeschützt. Nullwerte zulassend.|
|contactFolders|[contactFolder](contactfolder.md)-Sammlung|Die Kontakteordner des Benutzers. Schreibgeschützt. Nullwerte zulassend.|
|contacts|[contact](contact.md)-Sammlung|Die Kontakte des Benutzers. Schreibgeschützt. Nullwerte zulassend.|
...
|Ereignisse|[event](event.md)-Sammlung|Die Ereignisse des Benutzers. Standardmäßig werden Ereignisse unter dem Standard-Kalender angezeigt. Schreibgeschützt. Nullwerte zulassend.|
|Erweiterungen|[extension](extension.md)-Sammlung|Die Sammlung der für den Benutzer definierten offenen Erweiterungen. Nullwerte zulassend.|
...
|Einblicke|[insights](insights.md)-Sammlung| Schreibgeschützt. Nullwerte zulassend.|
|joinedGroups|[group](group.md)-Sammlung| Schreibgeschützt. Nullwerte zulassend.|
|mailFolders|[mailFolder](mailfolder.md)-Sammlung| Die E-Mail-Ordner des Benutzers. Schreibgeschützt. Nullwerte zulassend.|
...
|memberOf|[directoryObject](directoryobject.md)-Sammlung|Die Gruppen, Verzeichnisrollen und administrativen Einheiten, bei denen der Benutzer Mitglied ist. Schreibgeschützt. Nullwerte zulassend.|
|joinedTeams|[group](group.md)-Sammlung|Die Microsoft Teams, in denen der Benutzer Mitglied ist. Schreibgeschützt. Lässt NULL-Werte zu.|
|Nachrichten|[message](message.md)-Sammlung|Die Nachrichten in einem Postfach oder Ordner. Schreibgeschützt. Nullwerte zulassend.|
|onenote|[OneNote](onenote.md)| Schreibgeschützt.|
|outlook|[outlookUser](outlookuser.md)| Ausgewählte Outlook-Dienste, die für den Benutzer verfügbar sind. Schreibgeschützt. Lässt NULL-Werte zu.|
...
|Kontakte|[person](person.md)-Sammlung| Schreibgeschützt. Die wichtigsten Personen für den Benutzer. Die Sammlung ist nach ihrer Relevanz für den Benutzer sortiert, die von der Kommunikation, der Zusammenarbeit und den Geschäftsbeziehungen des Benutzers abhängt. Eine Person ist eine Ansammlung von Informationen aus E-Mails, Kontakten und sozialen Netzwerken.|
|photo|[profilePhoto](profilephoto.md)| Das Profilfoto des Benutzers. Schreibgeschützt.|
|Fotos|[photo](photo.md)-Sammlung| Schreibgeschützt. Nullwerte zulassend.|
|planner|[plannerUser](planneruser.md)| Selektive Planner-Dienste, die für den Benutzer zur Verfügung stehen. Schreibgeschützt. Nullwerte zulassend. |
|sharepoint|[sharepoint](sharepoint.md)| Zugriff auf die SharePoint-Website des Benutzers. Schreibgeschützt. |
|scopedRoleMemberOf|[scopedRoleMembership](scopedrolemembership.md)-Sammlung| Die Mitgliedschaften mit Bereichsrolle in administrativen Einheiten für diesen Benutzer. Schreibgeschützt. Nullwerte zulassend.|
|settings|[settings](user-settings.md)-Sammlung| Schreibgeschützt. Nullwerte zulassend.|
