...
|containedApps|[mobileContainedApp](../resources/intune-apps-mobilecontainedapp.md) -Sammlung|Die Sammlung der enthaltenen apps in einem mobileApp, das als Paket fungiert.|
