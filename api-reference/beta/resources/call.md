...
| [PlayPrompt](../api/call-playprompt.md)                           | [commsOperation](commsoperation.md)               | Wiedergabe Prompt in den Anruf.                     |
...
| callbackUri         | String                                                                                                 | Der Rückruf oder Abonnement-ID auf dem Rückrufe zugestellt werden.                                                                                                                               |
| chatInfo            | [chatInfo](chatinfo.md)                                                                                | Die Chat-Informationen.                                                                                                                                                                               |
| Richtung           | String                                                                                                 | Die Richtung des Anrufs. Die mögliche Werte sind `incoming` oder `outgoing`. Schreibgeschützt. Server generiert wurde.                                                                                            |
...
| myParticipantId     | String                                                                                                 | Schreibgeschützt. Server generiert wurde.                                                                                                                                                                        |
...
| state               | String                                                                                                 | Der Zustand des Anrufs. Mögliche Werte: `incoming`, `establishing`, `ringing`, `established`, `hold`, `transferring`, `transferAccepted`, `redirecting`, `terminating`, `terminated`. Schreibgeschützt. Server generiert wurde.                         |
| Betreff             | String                                                                                                 | Der Betreff der Unterhaltung.                                                                                                                                                                    |
...
| terminationReason   | String                                                                                                 | Schreibgeschützt. Server generiert wurde.                                                                                                                                                                        |
