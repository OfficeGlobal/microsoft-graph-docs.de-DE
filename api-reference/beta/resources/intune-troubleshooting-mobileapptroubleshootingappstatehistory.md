...
---
# <a name="mobileapptroubleshootingappstatehistory-resource-type"></a>mobileAppTroubleshootingAppStateHistory-Ressourcentyp
...
|actionType|[mobileAppActionType](../resources/intune-troubleshooting-mobileappactiontype.md)|AAD-Sicherheitsgruppen-ID, auf die Sie gezielt wurde. Mögliche Werte: `unknown`, `installCommandSent`, `installed`, `uninstalled`, `userRequestedInstall`.|
