...
|direction|connectionDirection|Richtung der Netzwerk-Verbindung. Mögliche Werte sind: `unknown`, `inbound` und `outbound`.|
...
|status|connectionStatus|Netzwerk-Verbindungsstatus. Mögliche Werte: `unknown`, `attempted`, `succeeded`, `blocked`, `failed`.|
