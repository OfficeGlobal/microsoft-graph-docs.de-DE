...
|:---------------|:--------|:----------|
|ChartPoint abrufen | [chartPoint](chartpoint.md) |Dient zum Lesen der Eigenschaften und der Beziehungen des chartPoint-Objekts.|
|[List](../api/chartpoint-list.md) | ChartPoint-Sammlung |Dient zum Abrufen der ChartPoint-Objektsammlung. |
|[Itemat](../api/chartpointscollection-itemat.md)|ChartPoint|Abrufen eines Punkts anhand seiner Position in der Datenreihe.|
