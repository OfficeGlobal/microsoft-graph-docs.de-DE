...
|[MacOSScepCertificateProfile löschen](../api/intune-deviceconfig-macosscepcertificateprofile-delete.md)|Keines|Löscht eine [MacOSScepCertificateProfile](../resources/intune-deviceconfig-macosscepcertificateprofile.md).|
