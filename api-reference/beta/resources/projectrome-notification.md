...
|:----|:-----|:-----------|
| targetHostName | Zeichenfolge | Stellt den Hostnamen der app auf die der aufrufende Dienst möchte die Benachrichtigung für den angegebenen Benutzer buchen. |
| appNotificationId | Zeichenfolge | Die eindeutige Id, die von der app-Server eine Benachrichtigung, die verwendet wird, zu identifizieren, und statten Sie eine einzelne Benachrichtigung festgelegt. |
...
| payload.rawContent | Zeichenfolge | Der Inhalt der Benachrichtigung über eine unformatierte User-Benachrichtigung, die an übermittelt und vom Empfang dieser Benachrichtigung app-Client verwendet werden. Mindestens eine der Payload.RawContent und Payload.VisualContent muss für eine Benachrichtigung POST-Anforderung gültig sein. |
...
| Payload.Visual.Title | Zeichenfolge | Der Titel einer Benachrichtigung visuelle Benutzer. Titel oder Textkörper benötigen. |
| Payload.Visual.Body | Zeichenfolge | Der Text einer Benachrichtigung visuelle Benutzer. Titel oder Textkörper benötigen. |
...
| groupName | Zeichenfolge | Der Name der Gruppe, zu der diese Benachrichtigung gehört. Es wird vom Entwickler zum Gruppieren von Benachrichtigungen festgelegt. |
