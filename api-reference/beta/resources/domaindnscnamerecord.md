...
# domainDnsCnameRecord-Ressourcentyp
...
|Bezeichnungsfeld|String| Wert, der beim Konfigurieren der *alias/host/name*-Eigenschaft des CNAME-Eintrags auf dem DNS-Host verwendet wird. |
